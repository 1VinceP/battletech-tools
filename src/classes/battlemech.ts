...
import {
  getHexDistanceFromModifier,
  getISEquipmentList,
  getMovementModifier,
} from "../utils";
import { addCommas } from "../utils/addCommas";
import {
  adjustAlphaStrikeDamage,
  calculateAlphaStrikeValue,
  IAlphaStrikeExport,
} from "../utils/calculateAlphaStrikeValue";
...
export class BattleMech {
  ...
  public reset() {
    ...
    if (this._tech.tag === "is") this.setHeatSinksType("single");
    else this.setHeatSinksType("double");
  ...
  public setTargets(a: ITargetToHit, b: ITargetToHit, c: ITargetToHit) {
  ...
  public hasCASE(loc: string): boolean {
  ...
  private _calcBattleValue() {
    ...
    this._calcLogBV +=
      "<strong>STEP 1: CALCULATE DEFENSIVE BATTLE RATING - TM p302</strong><br />";
    let totalArmorFactor = 2.5 * this.getTotalArmor();
    this._calcLogBV +=
      "Total Armor Factor = Armor Factor x 2.5: " +
      totalArmorFactor +
      " = 2.5 x " +
      this.getTotalArmor() +
      "<br />";
    ...
    switch (this._armorType.tag) {
      case "commercial":
        this._calcLogBV +=
          "Total Armor Factor = 0.5 * Total Armor Factor Modifier for Commercial Armor: " +
          totalArmorFactor +
          " x 0.5 = " +
      ...
      default:
        this._calcLogBV +=
          "Total Armor Factor = 1.0 * Total Armor Factor Modifier for Non-Commercial Armor:  " +
          totalArmorFactor +
          " x 1 = " +
          totalArmorFactor * 1 +
          "<br />";
    ...
    this._calcLogBV +=
      "Total Internal Structure Points = Internal Structure Points x 1.5: " +
      totalInternalStructurePoints +
      " = 1.5 x " +
    ...
    switch (this.getInternalStructureType()) {
      case "industrial":
        this._calcLogBV +=
          "Total Internal Structure BV = 0.5 x I.S. BV for Industrial Internal Structure: " +
          totalInternalStructurePoints +
          " x 0.5 = " +
      ...
      case "endo-steel":
        this._calcLogBV +=
          "Total Internal Structure = 1.0 x I.S. BV for Endo-Steel Internal Structure: " +
          totalInternalStructurePoints +
          " x 1 = " +
          totalInternalStructurePoints * 1 +
          "<br />";
        totalInternalStructurePoints = totalInternalStructurePoints * 1;
        break;
      default:
        this._calcLogBV +=
          "Total Internal Structure = 1.0 x I.S. BV for Standard Internal Structure:  " +
          totalInternalStructurePoints +
          " x 1 = " +
          totalInternalStructurePoints * 1 +
          "<br />";
    ...
    switch (this._engineType.tag) {
      case "light":
        this._calcLogBV +=
          "Total Internal Structure = 0.75 x I.S. BV for Light Engine: " +
          totalInternalStructurePoints +
          " x 0.5 = " +
          totalInternalStructurePoints * 0.5 +
          "<br />";
        totalInternalStructurePoints = totalInternalStructurePoints * 0.75;
        break;
      case "xl":
        // Inner Sphere XL
        this._calcLogBV +=
          "Total Internal Structure = 0.75 x I.S. BV for Inner Sphere XL Engine: " +
          totalInternalStructurePoints +
          " x 0.75 = " +
          totalInternalStructurePoints * 0.75 +
          "<br />";
        totalInternalStructurePoints = totalInternalStructurePoints * 0.75;
        break;
      ...
      case "clan-xl":
        // Clan XL
        this._calcLogBV +=
          "Total Internal Structure = 0.75 x I.S. BV for Clan XL Engine: " +
          totalInternalStructurePoints +
          " x 0.5 = " +
          totalInternalStructurePoints * 0.5 +
          "<br />";
      ...
      case "compact":
        this._calcLogBV +=
          "Total Internal Structure = 1.0 x I.S. BV for Compact Engine:  " +
          totalInternalStructurePoints +
          " x 1 = " +
          totalInternalStructurePoints * 1 +
          "<br />";
      ...
      default:
        this._calcLogBV +=
          "Total Internal Structure = 1.0 x I.S. BV for Standard Engine:  " +
          totalInternalStructurePoints +
          " x 1 = " +
          totalInternalStructurePoints * 1 +
          "<br />";
    ...
    switch (this.getInternalStructureType()) {
      case "compact":
        this._calcLogBV +=
          "Total Gyro BV = 0.5 x Tonnage for Compact Gyro: " +
          this.getTonnage() +
          " x 0.5 = " +
          this.getTonnage() * 0.5 +
          "<br />";
      ...
      case "xl":
        this._calcLogBV +=
          "Total Gyro BV = 0.5 x Tonnage for Extra Light Gyro: " +
          this.getTonnage() +
          " x 0.5 = " +
          this.getTonnage() * 0.5 +
          "<br />";
      ...
      case "heavy-duty":
        this._calcLogBV +=
          "Total Gyro BV = 1 x Tonnage for Heavy Duty Gyro: " +
          this.getTonnage() +
          " x 0.5 = " +
          this.getTonnage() * 0.5 +
          "<br />";
      ...
      default:
        this._calcLogBV +=
          "Total Gyro BV = 0.5 x Tonnage for Standard Gyro: " +
          this.getTonnage() +
          " x 0.5 = " +
          this.getTonnage() * 0.5 +
          "<br />";
    ...
    this._calcLogBV +=
      "<strong>Get Explosive Ammo Modifiers (TM p302-303)</strong><br />";
    ...
    if (this._tech.tag === "clan") {
      ...
      for (let lCrit = 0; lCrit < this._criticals.centerTorso.length; lCrit++) {
        ...
        if (item && item.obj && item.obj.explosive) {
          this._calcLogBV +=
            "Explosive Ammo Crit in Center Torso (Clan, -15)<br />";
          explosiveAmmoModifiers += 15;
        }
        if (item && item.obj && item.obj.gauss) {
      ...
      for (let lCrit = 0; lCrit < this._criticals.leftTorso.length; lCrit++) {
        if (this.hasXLEngine()) {
          ...
          if (item && item.obj && item.obj.explosive) {
            this._calcLogBV +=
              "Explosive Ammo Crit in Left Torso (Clan,-15)<br />";
            explosiveAmmoModifiers += 15;
          }
          if (item && item.obj && item.obj.gauss) {
      ...
      for (let lCrit = 0; lCrit < this._criticals.rightTorso.length; lCrit++) {
        if (this.hasXLEngine()) {
          ...
          if (item && item.obj && item.obj.explosive) {
            this._calcLogBV +=
              "Explosive Ammo Crit in Right Torso (Clan,-15)<br />";
            explosiveAmmoModifiers += 15;
          }
          if (item && item.obj && item.obj.gauss) {
      ...
      for (let lCrit = 0; lCrit < this._criticals.rightLeg.length; lCrit++) {
        ...
        if (item && item.obj && item.obj.explosive) {
          this._calcLogBV +=
            "Explosive Ammo Crit in Right Leg (Clan, -15)<br />";
          explosiveAmmoModifiers += 15;
        }
        if (item && item.obj && item.obj.gauss) {
      ...
      for (let lCrit = 0; lCrit < this._criticals.leftLeg.length; lCrit++) {
        ...
        if (item && item.obj && item.obj.explosive) {
          this._calcLogBV +=
            "Explosive Ammo Crit in Left Leg (Clan, -15)<br />";
          explosiveAmmoModifiers += 15;
        }
        if (item && item.obj && item.obj.gauss) {
      ...
      for (let lCrit = 0; lCrit < this._criticals.head.length; lCrit++) {
        ...
        if (item && item.obj && item.obj.explosive) {
          this._calcLogBV +=
            "Explosive Ammo Crit in Head (Inner Sphere,-15)<br />";
          explosiveAmmoModifiers += 15;
        }
      }
      ...
      for (let lCrit = 0; lCrit < this._criticals.centerTorso.length; lCrit++) {
        ...
        if (item && item.obj && item.obj.explosive) {
          this._calcLogBV +=
            "Explosive Ammo Crit in Center Torso (Inner Sphere,-15)<br />";
          explosiveAmmoModifiers += 15;
        }
        if (item && item.obj && item.obj.gauss) {
          this._calcLogBV +=
            "Gauss Crit in Center Torso (Inner Sphere, -1)<br />";
          explosiveAmmoModifiers += 1;
        }
      }
      ...
      for (let lCrit = 0; lCrit < this._criticals.leftTorso.length; lCrit++) {
        if (!this.hasCASE("lt") || this.hasXLEngine()) {
          ...
          if (item && item.obj && item.obj.explosive) {
            this._calcLogBV +=
              "Explosive Ammo Crit in Left Torso (Inner Sphere,-15)<br />";
            explosiveAmmoModifiers += 15;
          }
          if (item && item.obj && item.obj.gauss) {
            this._calcLogBV +=
              "Gauss Crit in Left Torso (Inner Sphere, -1)<br />";
            explosiveAmmoModifiers += 1;
          }
        }
      }
      ...
      for (let lCrit = 0; lCrit < this._criticals.rightTorso.length; lCrit++) {
        ...
        if (!this.hasCASE("rt") || this.hasXLEngine()) {
          ...
          if (item && item.obj && item.obj.explosive) {
            this._calcLogBV +=
              "Explosive Ammo Crit in Right Torso (Inner Sphere,-15)<br />";
            explosiveAmmoModifiers += 15;
          }
          if (item && item.obj && item.obj.gauss) {
            this._calcLogBV +=
              "Gauss Crit in Center Right (Inner Sphere, -1)<br />";
            explosiveAmmoModifiers += 1;
          }
        }
        // }
      ...
      for (let lCrit = 0; lCrit < this._criticals.rightLeg.length; lCrit++) {
        ...
        if (item && item.obj && item.obj.explosive) {
          this._calcLogBV +=
            "Explosive Ammo Crit in Right Leg (Inner Sphere, -15)<br />";
          explosiveAmmoModifiers += 15;
        }
        if (item && item.obj && item.obj.gauss) {
        ...
        if (caseEnabled_RT === false && caseEnabled_RL === false) {
          if (item && item.obj && item.obj.explosive) {
            this._calcLogBV +=
              "Explosive Ammo Crit in Right Leg, Right Torso and Right Leg to not have CASE (Inner Sphere, -15)<br />";
            explosiveAmmoModifiers += 15;
          }
          if (item && item.obj && item.obj.gauss) {
            this._calcLogBV +=
              "Gauss Crit in Right Leg, Right Torso and Right Leg to not have CASE (Inner Sphere, -1)<br />";
            explosiveAmmoModifiers += 1;
          }
        }
      }
      ...
      for (let lCrit = 0; lCrit < this._criticals.leftLeg.length; lCrit++) {
        ...
        if (item && item.obj && item.obj.explosive) {
          this._calcLogBV +=
            "Explosive Ammo Crit in Left Leg (Inner Sphere, -15)<br />";
          explosiveAmmoModifiers += 15;
        }
        if (item && item.obj && item.obj.gauss) {
        ...
        if (caseEnabled_LT === false && caseEnabled_LL === false) {
          ...
          if (item && item.obj && item.obj.explosive) {
            this._calcLogBV +=
              "Explosive Ammo Crit in Left Leg, Left Torso and Left Leg to not have CASE (Inner Sphere, -15)<br />";
            explosiveAmmoModifiers += 15;
          }
          if (item && item.obj && item.obj.gauss) {
            this._calcLogBV +=
              "Gauss Crit in Left Leg, Left Torso and Left Leg to not have CASE (Inner Sphere, -1)<br />";
            explosiveAmmoModifiers += 1;
          }
        }
      }
      ...
      for (let lCrit = 0; lCrit < this._criticals.rightArm.length; lCrit++) {
        if (caseEnabled_RT === false && caseEnabled_RA === false) {
          ...
          if (item && item.obj && item.obj.explosive) {
            this._calcLogBV +=
              "Explosive Ammo Crit in Right Arm, Right Torso and Right Arm to not have CASE (Inner Sphere, -15)<br />";
            explosiveAmmoModifiers += 15;
          }
          if (item && item.obj && item.obj.gauss) {
            this._calcLogBV +=
              "Gauss Crit in Right Arm, Right Torso and Right Arm to not have CASE (Inner Sphere, -1)<br />";
            explosiveAmmoModifiers += 1;
          }
        }
      }
      ...
      for (let lCrit = 0; lCrit < this._criticals.leftArm.length; lCrit++) {
        if (caseEnabled_LT === false && caseEnabled_LA === false) {
          ...
          if (item && item.obj && item.obj.explosive) {
            this._calcLogBV +=
              "Explosive Ammo Crit in Left Arm, Left Torso and Left Arm to not have CASE (Inner Sphere, -15)<br />";
            explosiveAmmoModifiers += 15;
          }
          if (item && item.obj && item.obj.gauss) {
            this._calcLogBV +=
              "Gauss Crit in Left Arm, Left Torso and Left Arm to not have CASE (Inner Sphere, -1)<br />";
            explosiveAmmoModifiers += 1;
          }
        }
      }
    ...
    defensiveBattleRating =
      totalArmorFactor +
      totalInternalStructurePoints +
      totalGyroPoints -
      explosiveAmmoModifiers;
    this._calcLogBV +=
    ...
    let moveModifier = 0;
    if (jumpModifier > runModifier) moveModifier = jumpModifier;
    else moveModifier = runModifier;

    this._calcLogBV += "Best TMM: " + moveModifier + "<br />";

    let defensiveFactorModifier = 1 + moveModifier / 10;
    if (defensiveFactorModifier < 1) defensiveFactorModifier = 1;

    this._calcLogBV +=
      "Defensive Factor (defensiveFactorModifier = 1 + TMM / 10): " +
      defensiveFactorModifier +
      " = 1 + " +
      moveModifier +
      " / 10<br />";
    ...
    this._calcLogBV +=
      "<strong> Defensive Factor Modifiers for equipment</strong>.... add camo, stealth, etc when tech is available<br />";
    ...
    this._calcLogBV +=
      "Defensive battle rating = Defensive battle rating * Target Modifier Rating : " +
      (defensiveBattleRating * defensiveFactorModifier).toFixed(2) +
      " = " +
      defensiveBattleRating +
      " x " +
      defensiveFactorModifier +
    ...
    this._calcLogBV +=
      "<strong>Final defensive battle rating</strong>: " +
      defensiveBattleRating.toFixed(2) +
      "<br />";
    ...
    this._calcLogBV +=
      "<strong>STEP 2: CALCULATE OFFENSIVE BATTLE RATING - TM p303</strong><br />";

    // TODO
    this._calcLogBV +=
      "<strong>Calculate Each Weapon’s Modified BV</strong><br />";
    ...
    for (let eqC = 0; eqC < this._equipmentList.length; eqC++) {
      ...
      if (currentItem.tag.indexOf("ammo-") > -1) {
        if (!ammoBV[currentItem.tag]) ammoBV[currentItem.tag] = 0;
        if (currentItem.battleValue)
          ammoBV[currentItem.tag] +=
            currentItem.battleValue * currentItem.weight;
        ...
        this._calcLogBV +=
          ...
          " - " +
          (currentItem.battleValue ? currentItem.battleValue : 0) *
            currentItem.weight +
          "<br />";
      } else {
        if (!weaponBV[currentItem.tag]) weaponBV[currentItem.tag] = 0;
        if (currentItem.battleValue)
    ...
    for (let weaponKey in weaponBV) {
      for (let ammoKey in ammoBV) {
        if (ammoKey.indexOf(weaponKey) > -1) {
          if (!simplifiedAmmoBV[weaponKey]) simplifiedAmmoBV[weaponKey] = 0;
    ...
    for (let ammoKey in simplifiedAmmoBV) {
      if (weaponBV[ammoKey]) {
        if (simplifiedAmmoBV[ammoKey] > weaponBV[ammoKey]) {
          this._calcLogBV +=
            "<strong>Excessive Ammo Rule</strong> setting " +
            ammoKey +
            " value to " +
            weaponBV[ammoKey] +
            " from " +
            simplifiedAmmoBV[ammoKey] +
            "<br />";
    ...
    this._calcLogBV +=
      "<strong>Total Ammo BV</strong> " + totalAmmoBV + "<br />";
    ...
    if (this.getHeatSinksType() === "single") {
      ...
      this._calcLogBV +=
        "<strong>Heat Efficiency</strong> " +
        mechHeatEfficiency +
        " (6 + " +
        this.getHeatSinks() +
        " - " +
        this.getMaxMovementHeat() +
        " )<br />";
    } else if (this.getHeatSinksType() === "double") {
      mechHeatEfficiency =
        6 + this.getHeatSinks() * 2 - this.getMaxMovementHeat();
      this._calcLogBV +=
        "<strong>Heat Efficiency</strong> " +
        mechHeatEfficiency +
        " (6 + " +
    ...
    if (this._calcLogBV.substring(0, this._calcLogBV.length - 3) === " + ") {
      this._calcLogBV = this._calcLogBV.substring(
        0,
        this._calcLogBV.length - 3,
      );
    }
        ...
        if (this._equipmentList[weaponC].tag.indexOf("ammo-") === -1) {
          ...
          if (inHalfCost === true && this._equipmentList[weaponC].bvHeat > 0) {
            ...
            if (currentItem && currentItem.rear) {
              if (
                this.getTotalBVFrontWeapons() < this.getTotalBVRearWeapons() ||
                this.isNotOnTorsoHeadOrLegs(currentItem.location)
              ) {
                if (currentItem.battleValue) {
                  this._calcLogBV +=
                    "+ Adding Heat Inefficient Rear Weapon " +
                    currentItem.name +
                    " (" +
                    (currentItem.location
                      ? currentItem.location
                      : "no location") +
                    ")  - " +
                    currentItem.battleValue +
                    " / 4 = " +
                    currentItem.battleValue / 4;
                  runningTotal += currentItem.battleValue / 2;
                }
              } else {
                if (
                  this.getTotalBVFrontWeapons() <
                    this.getTotalBVRearWeapons() ||
                  this.isNotOnTorsoHeadOrLegs(currentItem.location)
                ) {
                  if (currentItem.battleValue) {
                    this._calcLogBV +=
              ...
              if (currentItem.battleValue) {
                this._calcLogBV +=
                  "+ Adding Heat Inefficient Weapon " +
                  currentItem.name +
                  " (" +
                  (currentItem.location
                    ? currentItem.location
              ...
              if (currentItem.battleValue) {
                if (
                  ...
                  this._calcLogBV +=
                    ...
                    ")  -  bv " +
                    currentItem.battleValue +
                    " (not halved due to less front weapons bv), heat " +
                    currentItem.bvHeat +
                    "<br />";
          ...
          if (
            runningHeat >= mechHeatEfficiency &&
            // set above, never undefined, thanks TS
            // @ts-ignore
            this._equipmentList[weaponC].bvHeat > 0 &&
            inHalfCost === false
          ) {
            inHalfCost = true;
            this._calcLogBV +=
              " (weapon is last heat efficient, rest will be half cost)";
          }
    ...
    this._calcLogBV +=
      "<strong>Total Weapon BV</strong> " + totalWeaponBV + "<br />";
    ...
    this._calcLogBV +=
      "<strong>Final offensive battle rating</strong>: " +
      offensiveBattleRating.toFixed(2) +
      " ( " +
      totalWeaponBV +
      " (weaponBV) + " +
      totalAmmoBV +
    ...
    this._calcLogBV +=
      "<strong>STEP 3: CALCULATE FINAL BATTLE VALUE - TM p304</strong><br />";
    let finalBattleValue = defensiveBattleRating + offensiveBattleRating;
    this._calcLogBV +=
      "finalBattleValue = defensiveBattleRating + offensiveBattleRating: " +
      finalBattleValue.toFixed(2) +
      " = " +
      defensiveBattleRating.toFixed(2) +
      " + " +
      offensiveBattleRating.toFixed(2) +
    ...
    if (this._smallCockpit) {
      finalBattleValue = Math.round(finalBattleValue * 0.95);
      this._calcLogBV +=
        "Small Cockpit, multiply total by .95 and round final BV: " +
        finalBattleValue.toFixed(2) +
        "<br />";
    }

    this._calcLogBV +=
      "<strong>Final Battle Value</strong>: " +
      finalBattleValue.toFixed(2) +
      " rounded off " +
      Math.round(finalBattleValue) +
      "<br />";
  ...
  private _setPilotAdjustedBattleValue() {
    ...
    if (this._pilot.gunnery === 0 && this._pilot.piloting === 0) {
      this._pilotAdjustedBattleValue = this._pilotAdjustedBattleValue * 2.8;
      ...
      this._pilotAdjustedBattleValue = this._pilotAdjustedBattleValue * 1.6;
    } else if (this._pilot.gunnery === 5 && this._pilot.piloting === 0) {
      this._pilotAdjustedBattleValue = this._pilotAdjustedBattleValue * 1.5;
      ...
      this._pilotAdjustedBattleValue = this._pilotAdjustedBattleValue * 2.4;
    } else if (this._pilot.gunnery === 2 && this._pilot.piloting === 1) {
      this._pilotAdjustedBattleValue = this._pilotAdjustedBattleValue * 2.1;
    } else if (this._pilot.gunnery === 3 && this._pilot.piloting === 1) {
      this._pilotAdjustedBattleValue = this._pilotAdjustedBattleValue * 1.8;
      ...
      this._pilotAdjustedBattleValue = this._pilotAdjustedBattleValue * 1.4;
      ...
      this._pilotAdjustedBattleValue = this._pilotAdjustedBattleValue * 1.1;
      ...
      this._pilotAdjustedBattleValue = this._pilotAdjustedBattleValue * 1.3;
      ...
      this._pilotAdjustedBattleValue = this._pilotAdjustedBattleValue * 1.2;
      ...
      this._pilotAdjustedBattleValue = this._pilotAdjustedBattleValue * 0.9;
      ...
      this._pilotAdjustedBattleValue = this._pilotAdjustedBattleValue * 0.8;
  ...
  private _getSpeedFactorModifier(): number {
    ...
    if (runSpeedAndHalfJumpSpeed > 25) {
      return +(
        1 +
        Math.pow((this.getRunSpeed() + this.getJumpSpeed() / 2 - 5) / 10, 1.2)
      ).toFixed(2);
  ...
  public isQuad() {
    if (this._mechType.tag.toLowerCase() === "quad") return true;
    else return false;
  }
  ...
  private _calcCBillCost() {
    ...
    if (this._smallCockpit) {
      this._calcLogCBill +=
        "<tr><td><strong>Small Cockpit</strong></td><td>175,000</td></tr>\n";
      cbillDryTotal += 175000;
    } else {
      this._calcLogCBill +=
        "<tr><td><strong>Standard Cockpit</strong></td><td>200,000</td></tr>\n";
      cbillDryTotal += 200000;
    }

    // Life Support
    this._calcLogCBill +=
      "<tr><td><strong>Life Support</strong></td><td>50,000</td></tr>\n";
    cbillDryTotal += 50000;

    // Sensors
    this._calcLogCBill +=
      '<tr><td><strong>Sensors</strong><br /><span class="smaller-text">2,000 x Unit Tonnage [' +
      this.getTonnage() +
      "]</span></td><td>" +
      addCommas(2000 * this.getTonnage()) +
      "</td></tr>\n";
    cbillDryTotal += 2000 * this.getTonnage();

    this._calcLogCBill +=
      '<tr><td colspan="2" class="text-right"><strong>Cockpit Subtotal: ' +
      addCommas(cbillDryTotal) +
      "</strong></td></tr>\n";

    // Myomer
    if (this._hasTripleStrengthMyomer) {
      this._calcLogCBill +=
        '<tr><td><strong>Triple-Strength Myomer</strong><br /><span class="smaller-text">16,000 x Unit Tonnage [' +
        this.getTonnage() +
        "]</span></td><td>" +
        addCommas(16000 * this.getTonnage()) +
        "</td></tr>\n";
      cbillDryTotal += 16000 * this.getTonnage();
    } else {
      this._calcLogCBill +=
        '<tr><td><strong>Standard Musculature</strong><br /><span class="smaller-text">2,000 x Unit Tonnage [' +
        this.getTonnage() +
        "]</span></td><td>" +
        addCommas(2000 * this.getTonnage()) +
        "</td></tr>\n";
    ...
    this._calcLogCBill +=
      "<tr><td><strong>Internal Structure: " +
      this._selectedInternalStructure.name +
      "</strong><br />" +
      addCommas(this._selectedInternalStructure.cost) +
      " x Unit Tonnage [" +
      this.getTonnage() +
      "]</td><td>" +
      addCommas(this._selectedInternalStructure.cost * this.getTonnage()) +
      "</td></tr>\n";
    cbillDryTotal += this._selectedInternalStructure.cost * this.getTonnage();

    this._calcLogCBill +=
      '<tr><td colspan="2"><strong>Actuators</strong></td></tr>\n';

    let actuatorTotal = 0;
    // Actuators
    if (this._mechType.tag.toLowerCase() === "quad") {
      this._calcLogCBill +=
        '<tr><td>Right Front Upper Leg Actuator<br /><span class="smaller-text">150 x Unit Tonnage [' +
        this.getTonnage() +
        "]</span></td><td>" +
        addCommas(150 * this.getTonnage()) +
        "</td></tr>\n";
      cbillDryTotal += 150 * this.getTonnage();
      actuatorTotal += 150 * this.getTonnage();

      this._calcLogCBill +=
        '<tr><td>Right Front Lower Leg Actuator<br /><span class="smaller-text">80 x Unit Tonnage [' +
        this.getTonnage() +
        "]</span></td><td>" +
        addCommas(80 * this.getTonnage()) +
        "</td></tr>\n";
      cbillDryTotal += 80 * this.getTonnage();
      actuatorTotal += 80 * this.getTonnage();

      this._calcLogCBill +=
        '<tr><td>Right Front Foot Actuator<br /><span class="smaller-text">120 x Unit Tonnage [' +
        this.getTonnage() +
        "]</span></td><td>" +
        addCommas(120 * this.getTonnage()) +
        "</td></tr>\n";
      cbillDryTotal += 120 * this.getTonnage();
      actuatorTotal += 120 * this.getTonnage();

      this._calcLogCBill +=
        '<tr><td>Left Front Upper Leg Actuator<br /><span class="smaller-text">150 x Unit Tonnage [' +
        this.getTonnage() +
        "]</span></td><td>" +
        addCommas(150 * this.getTonnage()) +
        "</td></tr>\n";
      ...
      this._calcLogCBill +=
        '<tr><td>Left Front Lower Leg Actuator<br /><span class="smaller-text">80 x Unit Tonnage [' +
        this.getTonnage() +
        "]</span></td><td>" +
        addCommas(80 * this.getTonnage()) +
        "</td></tr>\n";
      ...
      this._calcLogCBill +=
        '<tr><td>Left Front Foot Actuator<br /><span class="smaller-text">120 x Unit Tonnage [' +
        this.getTonnage() +
        "]</span></td><td>" +
        addCommas(120 * this.getTonnage()) +
        "</td></tr>\n";
      ...
      this._calcLogCBill +=
        '<tr><td>Right Rear Upper Leg Actuator<br /><span class="smaller-text">150 x Unit Tonnage [' +
        this.getTonnage() +
        "]</span></td><td>" +
        addCommas(150 * this.getTonnage()) +
        "</td></tr>\n";
      ...
      this._calcLogCBill +=
        '<tr><td>Right Rear Lower Leg Actuator<br /><span class="smaller-text">80 x Unit Tonnage [' +
        this.getTonnage() +
        "]</span></td><td>" +
        addCommas(80 * this.getTonnage()) +
        "</td></tr>\n";
      ...
      this._calcLogCBill +=
        '<tr><td>Right Rear Foot Actuator<br /><span class="smaller-text">120 x Unit Tonnage [' +
        this.getTonnage() +
        "]</span></td><td>" +
        addCommas(120 * this.getTonnage()) +
        "</td></tr>\n";
      ...
      this._calcLogCBill +=
        '<tr><td>Left Rear Upper Leg Actuator<br /><span class="smaller-text">150 x Unit Tonnage [' +
        this.getTonnage() +
        "]</span></td><td>" +
        addCommas(150 * this.getTonnage()) +
        "</td></tr>\n";
      ...
      this._calcLogCBill +=
        '<tr><td>Left Rear Lower Leg Actuator<br /><span class="smaller-text">80 x Unit Tonnage [' +
        this.getTonnage() +
        "]</span></td><td>" +
        addCommas(80 * this.getTonnage()) +
        "</td></tr>\n";
      ...
      this._calcLogCBill +=
        '<tr><td>Left Rear Foot Actuator<br /><span class="smaller-text">120 x Unit Tonnage [' +
        this.getTonnage() +
        "]</span></td><td>" +
        addCommas(120 * this.getTonnage()) +
        "</td></tr>\n";
      ...
      this._calcLogCBill +=
        '<tr><td>Right Upper Leg Actuator<br /><span class="smaller-text">150 x Unit Tonnage [' +
        this.getTonnage() +
        "]</span></td><td>" +
        addCommas(150 * this.getTonnage()) +
        "</td></tr>\n";
      ...
      this._calcLogCBill +=
        '<tr><td>Right Lower Leg Actuator<br /><span class="smaller-text">80 x Unit Tonnage [' +
        this.getTonnage() +
        "]</span></td><td>" +
        addCommas(80 * this.getTonnage()) +
        "</td></tr>\n";
      ...
      this._calcLogCBill +=
        '<tr><td>Right Foot Actuator<br /><span class="smaller-text">120 x Unit Tonnage [' +
        this.getTonnage() +
        "]</span></td><td>" +
        addCommas(120 * this.getTonnage()) +
        "</td></tr>\n";
      ...
      this._calcLogCBill +=
        '<tr><td>Left Upper Leg Actuator<br /><span class="smaller-text">150 x Unit Tonnage [' +
        this.getTonnage() +
        "]</span></td><td>" +
        addCommas(150 * this.getTonnage()) +
        "</td></tr>\n";
      ...
      this._calcLogCBill +=
        '<tr><td>Left Lower Leg Actuator<br /><span class="smaller-text">80 x Unit Tonnage [' +
        this.getTonnage() +
        "]</span></td><td>" +
        addCommas(80 * this.getTonnage()) +
        "</td></tr>\n";
      ...
      this._calcLogCBill +=
        '<tr><td>Left Foot Actuator<br /><span class="smaller-text">120 x Unit Tonnage [' +
        this.getTonnage() +
        "]</span></td><td>" +
        addCommas(120 * this.getTonnage()) +
        "</td></tr>\n";
      ...
      this._calcLogCBill +=
        '<tr><td>Right Upper Arm Actuator<br /><span class="smaller-text">100 x Unit Tonnage [' +
        this.getTonnage() +
        "]</span></td><td>" +
        addCommas(100 * this.getTonnage()) +
        "</td></tr>\n";
      ...
      if (this._no_right_arm_lower_actuator === false) {
        this._calcLogCBill +=
          '<tr><td>Right Lower Arm Actuator<br /><span class="smaller-text">50 x Unit Tonnage [' +
          this.getTonnage() +
          "]</span></td><td>" +
          addCommas(50 * this.getTonnage()) +
          "</td></tr>\n";
      ...
      if (this._no_right_arm_hand_actuator === false) {
        this._calcLogCBill +=
          '<tr><td>Right Hand Actuator<br /><span class="smaller-text">80 x Unit Tonnage [' +
          this.getTonnage() +
          "]</span></td><td>" +
          addCommas(80 * this.getTonnage()) +
          "</td></tr>\n";
      ...
      this._calcLogCBill +=
        '<tr><td>Left Upper Arm Actuator<br /><span class="smaller-text">100 x Unit Tonnage [' +
        this.getTonnage() +
        "]</span></td><td>" +
        addCommas(100 * this.getTonnage()) +
        "</td></tr>\n";
      ...
      if (this._no_left_arm_lower_actuator === false) {
        this._calcLogCBill +=
          '<tr><td>Left Lower Arm Actuator<br /><span class="smaller-text">50 x Unit Tonnage [' +
          this.getTonnage() +
          "]</span></td><td>" +
          addCommas(50 * this.getTonnage()) +
          "</td></tr>\n";
      ...
      if (this._no_left_arm_hand_actuator === false) {
        this._calcLogCBill +=
          '<tr><td>Left Hand Actuator<br /><span class="smaller-text">80 x Unit Tonnage [' +
          this.getTonnage() +
          "]</span></td><td>" +
          addCommas(80 * this.getTonnage()) +
          "</td></tr>\n";
    ...
    this._calcLogCBill +=
      '<tr><td colspan="2" class="text-right"><strong>Actuator Subtotal: ' +
      addCommas(actuatorTotal) +
      "</strong></td></tr>\n";
    ...
    let engineCost =
      Math.round(
        ((enginecostMultiplier * engineRating * this.getTonnage()) / 75) * 100,
      ) / 100;
    this._calcLogCBill +=
      "<tr><td><strong>Engine: " +
      engineName +
      '</strong><br /><span class="smaller-text">' +
      addCommas(enginecostMultiplier) +
      " x Engine Rating  [" +
      engineRating +
      "] x Unit Tonnage [" +
      this.getTonnage() +
      "] / 75</span></td><td>" +
      addCommas(engineCost) +
      "</td></tr>\n";
    ...
    this._calcLogCBill +=
      ...
      gyroName +
      '</strong><br /><span class="smaller-text">' +
      addCommas(gyrocostMultiplier) +
      " x Gyro Tonnage [" +
      gyroTonnage +
      "]</span></td><td>" +
      addCommas(gyrocostMultiplier * gyroTonnage) +
      "</td></tr>\n";
    ...
    if (numberOfJumpJets) {
      ...
      this._calcLogCBill +=
        "<tr><td><strong>Jump Jets: " +
        jumpJetName +
        '</strong><br /><span class="smaller-text">' +
        addCommas(jumpJetCost) +
        " x (# Jump Jets [" +
        numberOfJumpJets +
        "])<sup>2</sup> x Unit Tonnage [" +
        this.getTonnage() +
        "]</span></td><td>" +
        addCommas(
          jumpJetCost * Math.pow(numberOfJumpJets, 2) * this.getTonnage(),
        ) +
        "</td></tr>\n";
      cbillDryTotal +=
        jumpJetCost * Math.pow(numberOfJumpJets, 2) * this.getTonnage();
    ...
    switch (heatSinkType) {
      case "single":
        this._calcLogCBill +=
          "<tr><td><strong>Heat Sinks: " +
          heatSinksName +
          '</strong><br /><span class="smaller-text">' +
          addCommas(heatSinksCost) +
          " x (Number of Heat Sinks over 10 [" +
          (numberOfHeatSinks - 10) +
          "])</span></td><td>" +
          addCommas(heatSinksCost * (numberOfHeatSinks - 10)) +
          "</td></tr>\n";
      ...
      case "double":
        this._calcLogCBill +=
          ...
          '</strong><br /><span class="smaller-text">' +
          addCommas(heatSinksCost) +
          " x (Number of Heat Sinks  [" +
          numberOfHeatSinks +
          "])</span></td><td>" +
          addCommas(heatSinksCost * numberOfHeatSinks) +
          "</td></tr>\n";
    ...
    this._calcLogCBill +=
      ...
      armorName +
      '</strong><br /><span class="smaller-text">' +
      addCommas(armorcostMultiplier) +
      " x Armor Tonnage [" +
      armorTonnage +
      "]</span></td><td>" +
      addCommas(armorcostMultiplier * armorTonnage) +
      "</td></tr>\n";
    ...
    for (let eqC = 0; eqC < this._equipmentList.length; eqC++) {
      if (this._equipmentList[eqC].tag.indexOf("ammo-") === -1) {
        this._calcLogCBill +=
          "<tr><td><strong>" +
          this._equipmentList[eqC].name +
          "</strong></td><td>" +
          addCommas(this._equipmentList[eqC].cbills) +
          "</td></tr>\n";
        ...
        this._calcLogCBill +=
          ...
          addCommas(
            this._equipmentList[eqC].cbills * this._equipmentList[eqC].weight,
          ) +
          '<div class="smaller-text">(not included in dry cost)</div></td></tr>\n';
        cbillAmmoTotal +=
          this._equipmentList[eqC].cbills * this._equipmentList[eqC].weight;
      }
    }
    ...
    this._calcLogCBill +=
      '<tr><td colspan="2" class="text-right">&nbsp;</td></tr>\n';
    this._calcLogCBill +=
      '<tr><td colspan="2" class="text-right"><strong>Dry Subtotal: ' +
      addCommas(cbillDryTotal) +
      "</strong></td></tr>\n";
    ...
    this._calcLogCBill +=
      '<tr><td colspan="2" class="text-right">&nbsp;</td></tr>\n';
    this._calcLogCBill +=
      '<tr><td colSpan="2">Cost Multiplier:<div class="smaller-text">Sub Total [' +
      addCommas(cbillDryTotal) +
      "] x (1 + Unit Tonnage [" +
      this.getTonnage() +
      "] / 100) - rounded up</div></td><td>" +
      (1 + this.getTonnage() / 100) +
      "</td></tr>";
    this._calcLogCBill +=
      '<tr><td class="text-right"><strong>Final Dry Cost</strong>:</td><td>' +
      addCommas(Math.ceil(cbillDryTotal * (1 + this.getTonnage() / 100))) +
      "</td></tr>\n";
    this._calcLogCBill +=
      '<tr><td class="text-right"><strong>Final Loaded Cost</strong>:</td><td>' +
      addCommas(
        Math.ceil(cbillDryTotal * (1 + this.getTonnage() / 100)) +
          cbillAmmoTotal,
      ) +
      "</td></tr>\n";
  ...
  public getCBillCost(withAMMO: boolean = false): string {
    if (withAMMO) return this._cbillCostWithAmmo;
    else return this._cbillCost;
  }

  public getCBillCostNumeric(withAMMO: boolean = false): number {
    if (withAMMO)
      return parseInt(this._cbillCostWithAmmo.replace(/,/g, ""), 10);
    else return parseInt(this._cbillCost.replace(/,/g, ""), 10);
  }
  ...
  public getEngineRating() {
    if (this._engine && this._engine.rating) return this._engine.rating;
    else return 0;
  }
  ...
  public getGyroWeight() {
    if (this._engine) {
      return Math.ceil(
        Math.ceil(this._engine.rating / 100) * this._gyro.weight_multiplier,
      );
    } else {
      return 0;
    }
  ...
  public calcAlphaStrike(): AlphaStrikeUnit {
    ...
    if (this._tonnage > 100) {
      ...
      this._calcLogAS +=
        "<strong>Setting Size to 4 (Superheavy)</strong><br />\n";
    ...
    this._calcLogAS +=
      "Converting total armor of " + this.getTotalArmor() + "<br />\n";
    this._calcLogAS +=
      "<strong>Setting Armor to " +
      this._alphaStrikeForceStats.armor +
      "</strong><br />\n";
    ...
    if (this.getTech().tag === "is") {
      switch (this._engineType.tag) {
        case "compact":
          ...
          this._calcLogAS +=
            "Engine is an IS Compact Engine <strong>setting structure to " +
            this._alphaStrikeForceStats.structure +
            "</strong><br />\n";
          break;
        case "xl":
          // XL
          ...
          this._calcLogAS +=
            "Engine is a Clan XL Engine <strong>setting structure to " +
            this._alphaStrikeForceStats.structure +
            "</strong><br />\n";
          break;
        case "light":
          ...
          this._calcLogAS +=
            "Engine is an IS Light Engine <strong>setting structure to " +
            this._alphaStrikeForceStats.structure +
            "</strong><br />\n";
          break;
        default:
          ...
          this._calcLogAS +=
            "Engine is an IS Standard Engine <strong>setting structure to " +
            this._alphaStrikeForceStats.structure +
            "</strong><br />\n";
          break;
      }
      ...
      switch (this._engineType.tag) {
        ...
        default:
          ...
          this._calcLogAS +=
            "Engine is a Clan Standard Engine <strong>setting structure to " +
            this._alphaStrikeForceStats.structure +
            "</strong><br />\n";
    ...
    for (
      let weapon_counter = 0;
      weapon_counter < this._equipmentList.length;
      weapon_counter++
    ) {
      ...
      if (
        this._equipmentList[weapon_counter].alphaStrike &&
        !this._equipmentList[weapon_counter].isAmmo
      ) {
        if (this._equipmentList[weapon_counter].alphaStrike.rangeLong > 0) {
          total_weapon_heat_long +=
            +this._equipmentList[weapon_counter].alphaStrike.heat;
        }
        ...
        if (this._equipmentList[weapon_counter].rear) {
          this._calcLogAS +=
            "Adding <strong>rear</strong> Weapon " +
            this._equipmentList[weapon_counter].tag +
            " - ";
          this._calcLogAS +=
            " ( " +
            this._equipmentList[weapon_counter].alphaStrike.rangeShort +
            ", ";
          this._calcLogAS +=
            this._equipmentList[weapon_counter].alphaStrike.rangeMedium + ", ";
          this._calcLogAS +=
            this._equipmentList[weapon_counter].alphaStrike.rangeLong + ", ";
          this._calcLogAS +=
            this._equipmentList[weapon_counter].alphaStrike.rangeExtreme +
            " )<br />\n";
          shortTotalDamageRear +=
            this._equipmentList[weapon_counter].alphaStrike.rangeShort;
          mediumTotalDamageRear +=
            this._equipmentList[weapon_counter].alphaStrike.rangeMedium;
          longTotalDamageRear +=
            this._equipmentList[weapon_counter].alphaStrike.rangeLong;
          extremeTotalDamageRear +=
            this._equipmentList[weapon_counter].alphaStrike.rangeExtreme;
        } else {
          shortTotalDamage +=
            this._equipmentList[weapon_counter].alphaStrike.rangeShort;
          ...
          this._calcLogAS +=
            "Adding Weapon " + this._equipmentList[weapon_counter].tag + " - ";
          this._calcLogAS +=
            " ( " +
            this._equipmentList[weapon_counter].alphaStrike.rangeShort +
            ", ";
        ...
        if (
          this._equipmentList[weapon_counter].alphaStrike.notes &&
          this._equipmentList[weapon_counter].alphaStrike.notes.length &&
          this._equipmentList[weapon_counter].alphaStrike.notes.length > 0
        ) {
          for (
            let nC = 0;
            nC < this._equipmentList[weapon_counter].alphaStrike.notes.length;
            nC++
          ) {
            if (
              this._alphaStrikeForceStats.abilityCodes.indexOf(
                this._equipmentList[weapon_counter].alphaStrike.notes[nC],
              ) === -1
            ) {
              this._alphaStrikeForceStats.abilityCodes.push(
                this._equipmentList[weapon_counter].alphaStrike.notes[nC],
    ...
    if (this.getJumpSpeed() > 0) {
      if (this.getJumpSpeed() < 3) move_heat += 3;
      else move_heat += +this.getJumpSpeed();
      ...
      move_heat += 2;
      this._calcLogAS +=
        "<strong>Move Is " + this.getWalkSpeed() * 2 + '"</strong><br />\n';
    }
    ...
    if (!has_explosive) {
      ...
      this._calcLogAS +=
        "Mech has no explosive components, gets ENE ability<br />\n";
    }

    let heatDissipation = 0;

    heatDissipation +=
      (10 + this._additionalHeatSinks) * this._heatSinkType.dissipation;
    ...
    if (
      this._alphaStrikeForceStats.damage.short >= 0.5 &&
      this._alphaStrikeForceStats.damage.short < 1
    ) {
      this._alphaStrikeForceStats.damage.short = 0;
      this._alphaStrikeForceStats.damage.shortMinimal = true;
    } else {
      this._alphaStrikeForceStats.damage.short = Math.ceil(
        this._alphaStrikeForceStats.damage.short,
      );
    }

    if (
      this._alphaStrikeForceStats.damage.medium >= 0.5 &&
      this._alphaStrikeForceStats.damage.medium < 1
    ) {
      this._alphaStrikeForceStats.damage.medium = 0;
      this._alphaStrikeForceStats.damage.mediumMinimal = true;
    } else {
      this._alphaStrikeForceStats.damage.medium = Math.ceil(
        this._alphaStrikeForceStats.damage.medium,
      );
    }
    if (
      this._alphaStrikeForceStats.damage.long >= 0.5 &&
      this._alphaStrikeForceStats.damage.long < 1
    ) {
      this._alphaStrikeForceStats.damage.long = 0;
      this._alphaStrikeForceStats.damage.longMinimal = true;
    } else {
      this._alphaStrikeForceStats.damage.long = Math.ceil(
        this._alphaStrikeForceStats.damage.long,
      );
    }
    if (
      this._alphaStrikeForceStats.damage.extreme >= 0.5 &&
      this._alphaStrikeForceStats.damage.extreme < 1
    ) {
      this._alphaStrikeForceStats.damage.extreme = 0;
      this._alphaStrikeForceStats.damage.extremeMinimal = true;
    } else {
      this._alphaStrikeForceStats.damage.extreme = Math.ceil(
        this._alphaStrikeForceStats.damage.extreme,
      );
    }

    this._calcLogAS +=
      "<strong>Base Short Damage: " +
      this._alphaStrikeForceStats.damage.short +
      "</strong><br />\n";
    this._calcLogAS +=
      "<strong>Base Medium Damage: " +
      this._alphaStrikeForceStats.damage.medium +
      "</strong><br />\n";
    this._calcLogAS +=
      "<strong>Base Long Damage: " +
      this._alphaStrikeForceStats.damage.long +
      "</strong><br />\n";
    this._calcLogAS +=
      "<strong>Base Extreme Damage: " +
      this._alphaStrikeForceStats.damage.extreme +
      "</strong><br />\n";

    let final_overheat_value = 0;

    let weapon_heat_damage_short = Math.ceil(
      (this._alphaStrikeForceStats.damage.short * heatDissipation) /
        (max_heat_output - 4),
    );
    let weapon_heat_damage_medium = Math.ceil(
      (this._alphaStrikeForceStats.damage.medium * heatDissipation) /
        (max_heat_output - 4),
    );
    let weapon_heat_damage_long = Math.ceil(
      (this._alphaStrikeForceStats.damage.long * heatDissipation) /
        (max_heat_output - 4),
    );
    ...
    if (
      weapon_heat_damage_medium !== this._alphaStrikeForceStats.damage.medium ||
      weapon_heat_damage_short !== this._alphaStrikeForceStats.damage.short
    ) {
      // Heat Modified Damage, p115 AS companion
      ...
      if (
        ...
        this._calcLogAS +=
          "total_weapon_heat_medium is over 3, weapon damages must be adjusted - " +
          weapon_heat_damage_medium +
          " as per p115<br />";

        final_overheat_value =
          this._alphaStrikeForceStats.damage.medium - weapon_heat_damage_medium;
      } else if (
        this._alphaStrikeForceStats.damage.short !== weapon_heat_damage_short
      ) {
    ...
    if (weapon_heat_damage_long > 4) {
      if (this._alphaStrikeForceStats.damage.long.toString() !== "0*") {
        ...
        if (heat_damage_long > +this._alphaStrikeForceStats.damage.long) {
          final_long_overheat_value =
            heat_damage_long - +this._alphaStrikeForceStats.damage.long;
          this._alphaStrikeForceStats.damage.long =
            heat_damage_long - final_long_overheat_value;
          this._alphaStrikeForceStats.damage.extreme =
            heat_damage_extreme - final_long_overheat_value;
        }
      }
    }
    ...
    if (final_long_overheat_value > 0) {
      this._alphaStrikeForceStats.abilityCodes.push(
        "OVL " + final_long_overheat_value,
      );
    }

    this._alphaStrikeForceStats.damage = adjustAlphaStrikeDamage(
      this._alphaStrikeForceStats.damage,
      true,
    );

    // Determine Overheat Values - p116 AS Companion
    if (final_overheat_value > 4) final_overheat_value = 4;
    ...
    this._calcLogAS +=
      "Long Weapon Heat: " + total_weapon_heat_long + "<br />\n";
    this._calcLogAS += "Heat Dissipation: " + heatDissipation + "<br />\n";

    this._calcLogAS +=
      "Short Overheat Damage: " + weapon_heat_damage_short + "<br />\n";
    this._calcLogAS +=
      "Medium Overheat Damage: " + weapon_heat_damage_medium + "<br />\n";
    this._calcLogAS +=
      "Long Overheat Damage: " + weapon_heat_damage_long + "<br />\n";
    this._calcLogAS +=
      "Final Overheat Damage: " + final_overheat_value + "<br />\n";

    this._calcLogAS +=
      "<strong>Final Short Damage: " +
      this._alphaStrikeForceStats.damage.short +
      "</strong><br />\n";
    this._calcLogAS +=
      "<strong>Final Medium Damage: " +
      this._alphaStrikeForceStats.damage.medium +
      "</strong><br />\n";
    this._calcLogAS +=
      "<strong>Final Long Damage: " +
      this._alphaStrikeForceStats.damage.long +
      "</strong><br />\n";
    this._calcLogAS +=
      "<strong>Final Extreme Damage: " +
      this._alphaStrikeForceStats.damage.extreme +
      "</strong><br />\n";

    // Overheat Value is
    this._calcLogAS +=
      "<strong>Final Overheat Value: " +
      final_overheat_value +
      "</strong><br />\n";
    this._calcLogAS +=
      "<strong>Final Long Overheat Value: " +
      final_long_overheat_value +
      "</strong><br />\n";
    ...
    if (this._alphaStrikeForceStats.jumpMove) {
      asMechData["BFMove"] =
        this._alphaStrikeForceStats.move.toString() +
        '"/' +
        this._alphaStrikeForceStats.jumpMove +
        '"J';
    } else {
    ...
    asMechData["BFAbilities"] = this._alphaStrikeForceStats.abilityCodes
      .join(", ")
      .toUpperCase();
  ...
  public makeTROBBCode() {
    ...
    html +=
      "" +
      ("Internal Structure ( " + this._selectedInternalStructure.name + " )")
        .toString()
        .padEnd(col1Padding + col2Padding, " ") +
      "" +
      this.getInternalStructureWeight() +
      "\n";
    html +=
      "" +
      this.getEngineName().padEnd(col1Padding, " ") +
      "" +
      this.getEngineRating().toString().padEnd(col2Padding, " ") +
      "" +
      this.getEngineWeight() +
      "\n";

    html +=
      "Walking".padStart(col1Padding - 10, " ") +
      " " +
      this.getWalkSpeed().toString().padStart(3, " ") +
      "\n";
    html +=
      "Running".padStart(col1Padding - 10, " ") +
      " " +
      this.getRunSpeed().toString().padStart(3, " ") +
      "\n";
    html +=
      "Jumping".padStart(col1Padding - 10, " ") +
      " " +
      this.getJumpSpeed().toString().padStart(3, " ") +
      "\n";

    html +=
      "" +
      this.getHeatSyncName().padEnd(col1Padding, " ") +
      "" +
      this.getHeatSinks().toString().padEnd(col2Padding, " ") +
      "" +
      this.getHeatSinksWeight() +
      "\n";
    html +=
      "" +
      this.getGyroName().padEnd(col1Padding + col2Padding, " ") +
      "" +
      this.getGyroWeight() +
      "\n";
    ...
    if (this._smallCockpit) {
      html +=
        "Small Cockpit".padEnd(col1Padding + col2Padding, " ") +
        "" +
        this.getCockpitWeight() +
        "\n";
    } else {
      html +=
        "Cockpit".padEnd(col1Padding + col2Padding, " ") +
        "" +
        this.getCockpitWeight() +
        "\n";
    }
    ...
    if (this._mechType.tag === "biped") {
      ...
      if (this.hasLowerArmActuator("ra")) actuator_html += "RLA, ";
      if (this.hasLowerArmActuator("la")) actuator_html += "LLA, ";
      if (this.hasHandActuator("ra")) actuator_html += "RH, ";
      if (this.hasHandActuator("la")) actuator_html += "LH, ";

      if (actuator_html === "") actuator_html = "No lower arm actuators";
      else actuator_html = actuator_html.substring(0, actuator_html.length - 2);
    ...
    html +=
      "" +
      ("Armor Value ( " + this._armorType.name + " )").padEnd(
        col1Padding,
        " ",
      ) +
      "" +
      this.getTotalArmor().toString().padEnd(col2Padding, " ") +
      "" +
      this.getArmorWeight() +
      "\n";
    ...
    html +=
      "Internal Structure".padStart(col1Padding + col2Padding, " ") +
      "Armor Value".padStart(col3Padding, " ") +
      "\n";
    html +=
      "Head".padStart(col1Padding, " ") +
      "" +
      this._internalStructure.head.toString().padStart(col2Padding, " ") +
      "" +
      this._armorAllocation.head.toString().padStart(col3Padding, " ") +
      "\n";
    html +=
      "Center Torso".padStart(col1Padding, " ") +
      "" +
      this._internalStructure.centerTorso
        .toString()
        .padStart(col2Padding, " ") +
      "" +
      this._armorAllocation.centerTorso.toString().padStart(col3Padding, " ") +
      "\n";
    html +=
      "Center Torso (Rear)".padStart(col1Padding, " ") +
      "" +
      this._armorAllocation.centerTorsoRear
        .toString()
        .padStart(col2Padding, " ") +
      "\n";
    if (
      this._armorAllocation.rightTorso === this._armorAllocation.leftTorso &&
      this._armorAllocation.rightTorsoRear ===
        this._armorAllocation.leftTorsoRear
    ) {
      html +=
        "R/L Torso".padStart(col1Padding, " ") +
        "" +
        this._internalStructure.rightTorso
          .toString()
          .padStart(col2Padding, " ") +
        "" +
        this._armorAllocation.rightTorso.toString().padStart(col3Padding, " ") +
        "\n";
      html +=
        "R/L Torso (Rear)".padStart(col1Padding, " ") +
        "" +
        this._armorAllocation.rightTorsoRear
          .toString()
          .padStart(col2Padding, " ") +
      ...
      html +=
        "Right Torso".padStart(col1Padding, " ") +
        "" +
        this._internalStructure.rightTorso
          .toString()
          .padStart(col2Padding, " ") +
        ...
        "\n";
      html +=
        "Right Torso (Rear)".padStart(col1Padding, " ") +
        "" +
        this._armorAllocation.rightTorsoRear
          .toString()
          .padStart(col2Padding, " ") +
      ...
      html +=
        "Left Torso".padStart(col1Padding, " ") +
        "" +
        this._internalStructure.leftTorso
          .toString()
          .padStart(col2Padding, " ") +
        "" +
        this._armorAllocation.leftTorso.toString().padStart(col3Padding, " ") +
        "\n";
      html +=
        "Left Torso (Rear)".padStart(col1Padding, " ") +
        "" +
        this._armorAllocation.leftTorsoRear
          .toString()
          .padStart(col2Padding, " ") +
    ...
    if (this._mechType.tag === "biped") {
      if (this._armorAllocation.rightArm === this._armorAllocation.leftArm) {
        html +=
          "R/L Arm".padStart(col1Padding, " ") +
          "" +
          this._internalStructure.rightArm
            .toString()
            .padStart(col2Padding, " ") +
          "" +
          this._armorAllocation.rightArm.toString().padStart(col3Padding, " ") +
          "\n";
      } else {
        html +=
          "Right Arm".padStart(col1Padding, " ") +
          "" +
          this._internalStructure.rightArm
            .toString()
            .padStart(col2Padding, " ") +
          ...
          "\n";
        html +=
          "Left Arm".padStart(col1Padding, " ") +
          "" +
          this._internalStructure.leftArm
            .toString()
            .padStart(col2Padding, " ") +
          "" +
          this._armorAllocation.leftArm.toString().padStart(col3Padding, " ") +
          "\n";
      }

      if (this._armorAllocation.rightLeg === this._armorAllocation.leftLeg) {
        html +=
          "R/L Leg".padStart(col1Padding, " ") +
          "" +
          this._internalStructure.rightLeg
            .toString()
            .padStart(col2Padding, " ") +
          "" +
          this._armorAllocation.rightLeg.toString().padStart(col3Padding, " ") +
          "\n";
      } else {
        html +=
          "Right Leg".padStart(col1Padding, " ") +
          "" +
          this._internalStructure.rightLeg
            .toString()
            .padStart(col2Padding, " ") +
          ...
          "\n";
        html +=
          "Left Leg".padStart(col1Padding, " ") +
          "" +
          this._internalStructure.leftLeg
            .toString()
            .padStart(col2Padding, " ") +
          "" +
          this._armorAllocation.leftLeg.toString().padStart(col3Padding, " ") +
          "\n";
      }
    } else {
      if (this._armorAllocation.rightArm === this._armorAllocation.leftArm) {
        html +=
          "R/L Front Leg".padStart(col1Padding, " ") +
          "" +
          this._internalStructure.rightArm
            .toString()
            .padStart(col2Padding, " ") +
        ...
        html +=
          "Right Front Leg".padStart(col1Padding, " ") +
          "" +
          this._internalStructure.rightArm
            .toString()
            .padStart(col2Padding, " ") +
          ...
          "\n";
        html +=
          "Left Front Leg".padStart(col1Padding, " ") +
          "" +
          this._internalStructure.leftArm
            .toString()
            .padStart(col2Padding, " ") +
      ...
      if (this._armorAllocation.rightLeg === this._armorAllocation.leftLeg) {
        html +=
          "R/L Rear Leg".padStart(col1Padding, " ") +
          "" +
          this._internalStructure.rightLeg
            .toString()
            .padStart(col2Padding, " ") +
        ...
        html +=
          "Right Rear Leg".padStart(col1Padding, " ") +
          "" +
          this._internalStructure.rightLeg
            .toString()
            .padStart(col2Padding, " ") +
    ...
    for (let locC = 0; locC < this._validJJLocations.length; locC++) {
      for (
        let critC = 0;
        critC < this._criticals[this._validJJLocations[locC].long].length;
        critC++
      ) {
    ...
    html +=
      "and Ammo".padEnd(col1Padding, " ") +
      "Location".padEnd(col2Padding, " ") +
      "Critical".padEnd(col3Padding, " ") +
      "Tonnage".padEnd(col4Padding, " ") +
      "\n";
    ...
    for (let countEQ = 0; countEQ < this._equipmentList.length; countEQ++) {
      ...
      if (currentItem.rear) item_location += " (R)";

      if (currentItem.ammoPerTon && currentItem.ammoPerTon > 0) {
        html +=
          "" +
          (currentItem.name + " " + currentItem.ammoPerTon).padEnd(
            col1Padding,
            " ",
          ) +
          "" +
          item_location.toUpperCase().toString().padEnd(col2Padding, " ") +
          "" +
          currentItem.space.battlemech.toString().padEnd(col3Padding, " ") +
          "" +
          currentItem.weight.toString().padEnd(col4Padding, " ") +
          "\n";
      } else {
        html +=
          "" +
          currentItem.name.padEnd(col1Padding, " ") +
          "" +
          item_location.toUpperCase().toString().padEnd(col2Padding, " ") +
          "" +
          currentItem.space.battlemech.toString().padEnd(col3Padding, " ") +
    ...
    for (let locC = 0; locC < this._validJJLocations.length; locC++) {
      ...
      for (
        ...
        let currentItem =
          this._criticals[this._validJJLocations[locC].long][critC];
        if (
          currentItem &&
          currentItem.tag &&
      ...
      if (jjObjs.length > 0) {
        ...
        if (this._tonnage <= 55) {
          // 10-55 tons
          areaWeight =
            jjObjs.length * this._jumpJetType.weight_multiplier.light;
        } else if (this._tonnage <= 85) {
          // 60 - 85 tons
          areaWeight =
            jjObjs.length * this._jumpJetType.weight_multiplier.medium;
        } else {
          // 90+ tons
          areaWeight =
            jjObjs.length * this._jumpJetType.weight_multiplier.heavy;
        }
        html +=
          "" +
          jjObjs[0].name.padEnd(col1Padding, " ") +
          "" +
          this._validJJLocations[locC].short
            .toUpperCase()
            .padEnd(col2Padding, " ") +
          "" +
          jjObjs.length.toString().padEnd(col3Padding, " ") +
          "" +
          areaWeight.toString().padEnd(col4Padding, " ") +
          "\n";
      }
    }
    ...
    if (jjObjs.length > 0) {
      ...
      html +=
        "" +
        jjObjs[0].name.padEnd(col1Padding, " ") +
        "n/a".toUpperCase().padEnd(col2Padding, " ") +
        "" +
        jjObjs.length.toString().padEnd(col3Padding, " ") +
        "" +
        areaWeight.toString().padEnd(col4Padding, " ") +
  ...
  public makeTROHTML() {
    ...
    html +=
      '<tr><td colspan="4">Technology Base: ' +
      this.getTech().name +
      "</td></tr>";
    html += '<tr><td colspan="4">Era: ' + this.getEra().name + "</td></tr>";
    html += '<tr><td colspan="4">Tonnage: ' + this.getTonnage() + "</td></tr>";
    html +=
      '<tr><td colspan="4">Battle Value: ' +
      this.getBattleValue() +
      "</td></tr>";
    html +=
      '<tr><td colspan="4">Alpha Strike Value: ' +
      this.getAlphaStrikeValue() +
      "</td></tr>";
    html +=
      '<tr><td colspan="4">C-Bill Cost: $' + this.getCBillCost() + "</td></tr>";
    html +=
      '<tr><td colspan="4">C-Bill Cost with Ammo: $' +
      this.getCBillCost(true) +
      "</td></tr>";
    ...
    // Equipment
    html +=
      '<tr><th class="text-left" colspan="3">Equipment</th><th class="text-center" colspan="1">Mass</th></tr>';
    html +=
      '<tr><td colspan="3">Internal Structure ( ' +
      this._selectedInternalStructure.name +
    ...
    html +=
      '<tr><td colspan="1" class="text-right">Walking</td><td class="text-center" colspan="2">' +
      this.getWalkSpeed() +
      '</td><td colspan="1">&nbsp;</td></tr>';
    html +=
      '<tr><td colspan="1" class="text-right">Running</td><td class="text-center" colspan="2">' +
      this.getRunSpeed() +
      '</td><td colspan="1">&nbsp;</td></tr>';
    html +=
      '<tr><td colspan="1" class="text-right">Jumping</td><td class="text-center" colspan="2">' +
      this.getJumpSpeed() +
      '</td><td colspan="1">&nbsp;</td></tr>';

    html +=
      '<tr><td colspan="1">' +
      this.getHeatSyncName() +
      '</td><td class="text-center" colspan="2">' +
      this.getHeatSinks() +
      '</td><td class="text-center" colspan="1">' +
      this.getHeatSinksWeight() +
    ...
    if (this._smallCockpit) {
      html +=
        '<tr><td colspan="3">Small Cockpit</td><td class="text-center" colspan="1">' +
        this.getCockpitWeight() +
        "</td></tr>";
    } else {
      html +=
        '<tr><td colspan="3">Cockpit</td><td class="text-center" colspan="1">' +
        this.getCockpitWeight() +
        "</td></tr>";
    }
    ...
    html +=
      '<tr><th colspan="1">Armor Value ( ' +
      this._armorType.name +
      ' )</th><th class="text-center" colspan="2">' +
      this.getTotalArmor() +
      '</th><th class="text-center" colspan="1">' +
      this.getArmorWeight() +
      "</th></tr>";

    // Armor Factor Table
    html +=
      '<tr><td colspan="1"></td><td class="text-center" colspan="1"><em style="font-size: 12px;">Internal Structure</em></td><td class="text-center" colspan="1"><em style="font-size: 12px;">Armor Value</em></td><td>&nbsp;</td></tr>';
    html +=
      '<tr><td  class="text-right"colspan="1">Head</td><td class="text-center" colspan="1">' +
      this._internalStructure.head +
      '</td><td class="text-center" colspan="1">' +
      this._armorAllocation.head +
      "</td><td>&nbsp;</td></tr>";
    html +=
      '<tr><td  class="text-right"colspan="1">Center Torso</td><td class="text-center" colspan="1">' +
      this._internalStructure.centerTorso +
      '</td><td class="text-center" colspan="1">' +
      this._armorAllocation.centerTorso +
      "</td><td>&nbsp;</td></tr>";
    html +=
      '<tr><td  class="text-right"colspan="1">Center Torso (Rear)</td><td class="text-center" colspan="1">&nbsp;</td><td class="text-center" colspan="1">' +
      this._armorAllocation.centerTorsoRear +
      "</td><td>&nbsp;</td></tr>";
    if (
      this._armorAllocation.rightTorso === this._armorAllocation.leftTorso &&
      ...
      html +=
        '<tr><td  class="text-right"colspan="1">R/L Torso</td><td class="text-center" colspan="1">' +
        this._internalStructure.rightTorso +
        '</td><td class="text-center" colspan="1">' +
        this._armorAllocation.rightTorso +
        "</td><td>&nbsp;</td></tr>";
      html +=
        '<tr><td  class="text-right"colspan="1">R/L Torso (Rear)</td><td class="text-center" colspan="1">&nbsp;</td><td class="text-center" colspan="1">' +
        this._armorAllocation.rightTorsoRear +
        "</td><td>&nbsp;</td></tr>";
    } else {
      html +=
        '<tr><td  class="text-right"colspan="1">Right Torso</td><td class="text-center" colspan="1">' +
        this._internalStructure.rightTorso +
        '</td><td class="text-center" colspan="1">' +
        this._armorAllocation.rightTorso +
        "</td><td>&nbsp;</td></tr>";
      html +=
        '<tr><td  class="text-right"colspan="1">Right Torso (Rear)</td><td class="text-center" colspan="1">&nbsp;</td><td class="text-center" colspan="1">' +
        this._armorAllocation.rightTorsoRear +
        "</td><td>&nbsp;</td></tr>";

      html +=
        '<tr><td  class="text-right"colspan="1">Left Torso</td><td class="text-center" colspan="1">' +
        this._internalStructure.leftTorso +
        '</td><td class="text-center" colspan="1">' +
        this._armorAllocation.leftTorso +
        "</td><td>&nbsp;</td></tr>";
      html +=
        '<tr><td  class="text-right"colspan="1">Left Torso (Rear)</td><td class="text-center" colspan="1">&nbsp;</td><td class="text-center" colspan="1">' +
        this._armorAllocation.leftTorsoRear +
        "</td><td>&nbsp;</td></tr>";
    }
    if (this._mechType.tag === "biped") {
      if (this._armorAllocation.rightArm === this._armorAllocation.leftArm) {
        html +=
          '<tr><td  class="text-right"colspan="1">R/L Arm</td><td class="text-center" colspan="1">' +
          this._internalStructure.rightArm +
          '</td><td class="text-center" colspan="1">' +
          this._armorAllocation.rightArm +
          "</td><td>&nbsp;</td></tr>";
      } else {
        html +=
          '<tr><td  class="text-right"colspan="1">Right Arm</td><td class="text-center" colspan="1">' +
          this._internalStructure.rightArm +
          '</td><td class="text-center" colspan="1">' +
          this._armorAllocation.rightArm +
          "</td><td>&nbsp;</td></tr>";
        html +=
          '<tr><td  class="text-right"colspan="1">Left Arm</td><td class="text-center" colspan="1">' +
          this._internalStructure.leftArm +
          '</td><td class="text-center" colspan="1">' +
          this._armorAllocation.leftArm +
          "</td><td>&nbsp;</td></tr>";
      }

      if (this._armorAllocation.rightLeg === this._armorAllocation.leftLeg) {
        html +=
          '<tr><td  class="text-right"colspan="1">R/L Leg</td><td class="text-center" colspan="1">' +
          this._internalStructure.rightLeg +
          '</td><td class="text-center" colspan="1">' +
          this._armorAllocation.rightLeg +
          "</td><td>&nbsp;</td></tr>";
      } else {
        html +=
          '<tr><td  class="text-right"colspan="1">Right Leg</td><td class="text-center" colspan="1">' +
          this._internalStructure.rightLeg +
          '</td><td class="text-center" colspan="1">' +
          this._armorAllocation.rightLeg +
          "</td><td>&nbsp;</td></tr>";
        html +=
          '<tr><td  class="text-right"colspan="1">Left Leg</td><td class="text-center" colspan="1">' +
          this._internalStructure.leftLeg +
          '</td><td class="text-center" colspan="1">' +
          this._armorAllocation.leftLeg +
          "</td><td>&nbsp;</td></tr>";
      }
    } else {
      if (this._armorAllocation.rightArm === this._armorAllocation.leftArm) {
        html +=
          '<tr><td  class="text-right"colspan="1">R/L Front Leg</td><td class="text-center" colspan="1">' +
          this._internalStructure.rightArm +
          '</td><td class="text-center" colspan="1">' +
          this._armorAllocation.rightArm +
          "</td><td>&nbsp;</td></tr>";
        ...
        html +=
          '<tr><td  class="text-right"colspan="1">Right Front Leg</td><td class="text-center" colspan="1">' +
          this._internalStructure.rightArm +
          '</td><td class="text-center" colspan="1">' +
          this._armorAllocation.rightArm +
          "</td><td>&nbsp;</td></tr>";
        html +=
          '<tr><td  class="text-right"colspan="1">Left Front Leg</td><td class="text-center" colspan="1">' +
          this._internalStructure.leftArm +
          '</td><td class="text-center" colspan="1">' +
          this._armorAllocation.leftArm +
          "</td><td>&nbsp;</td></tr>";
      ...
      if (this._armorAllocation.rightLeg === this._armorAllocation.leftLeg) {
        html +=
          '<tr><td  class="text-right"colspan="1">R/L Rear Leg</td><td class="text-center" colspan="1">' +
          this._internalStructure.rightLeg +
          '</td><td class="text-center" colspan="1">' +
          this._armorAllocation.rightLeg +
          "</td><td>&nbsp;</td></tr>";
        ...
        html +=
          '<tr><td  class="text-right"colspan="1">Right Rear Leg</td><td class="text-center" colspan="1">' +
          this._internalStructure.rightLeg +
          '</td><td class="text-center" colspan="1">' +
          this._armorAllocation.rightLeg +
          "</td><td>&nbsp;</td></tr>";
    ...
    html +=
      '<tr><th class="text-left">Weapons<br />and Ammo</th><th class="text-center">Location</th><th class="text-center">Critical</th><th class="text-center">Tonnage</th></tr>';
    ...
    for (let countEQ = 0; countEQ < this._equipmentList.length; countEQ++) {
      ...
      if (
        currentItem.isAmmo &&
        currentItem.ammoPerTon &&
        currentItem.ammoPerTon > 0
      )
        html +=
          ...
          item_location.toUpperCase() +
          '</strong></td><td class="text-center">' +
          currentItem.space.battlemech +
          '</td><td class="text-center">' +
          currentItem.weight +
          "</td></tr>";
      else
      ...
      if (jjObjs.length > 0) {
        ...
        if (jjObj) {
          html +=
            ...
            jjObj.name +
            '</td><td class="text-center">' +
            this._validJJLocations[locC].short.toUpperCase() +
            '</strong></td><td class="text-center">' +
            jjObjs.length +
            '</td><td class="text-center">' +
            areaWeight +
    ...
    if (jjObjs.length > 0) {
      ...
      html +=
        '<tr><td class="text-left">' +
        jjObjs[0].name +
        '</td><td class="text-center">n/a'.toUpperCase() +
        '</strong></td><td class="text-center">' +
        jjObjs.length +
        '</td><td class="text-center">' +
        areaWeight +
  ...
  private _getLocationAbbr(locationTag: string) {
    for (let countLoc = 0; countLoc < battlemechLocations.length; countLoc++) {
      if (locationTag === battlemechLocations[countLoc].tag) {
        ...
        else return battlemechLocations[countLoc].abbr;
      }
    }
    return "n/a";
  }
  ...
  private _calc() {
    ...
    if (this.getTech().tag === "clan") {
      this._maxArmor = Math.floor(
        this._armorWeight * this.getArmorObj().armorMultiplier.clan,
      );
    } else {
      this._maxArmor = Math.floor(
        this._armorWeight * this.getArmorObj().armorMultiplier.is,
      );
    }

    if (this._totalArmor > this._maxArmor) this._totalArmor = this._maxArmor;
    ...
    for (
      ...
      weight_counter < this._weights.length;
      weight_counter++
    ) {
    ...
    this._heatDissipation =
      (this._additionalHeatSinks + 10) * this._heatSinkType.dissipation;
    if (this.getTech().tag === "clan") {
    ...
    if (findEngine && findEngine.rating) {
      this._heatSinkCriticals.number =
        this._additionalHeatSinks + 10 - Math.floor(findEngine.rating / 25);
    } else {
      this._heatSinkCriticals.number = 0;
    }
    ...
    for (let countEQ = 0; countEQ < this._equipmentList.length; countEQ++) {
      ...
      for (
        let se_count = 0;
        se_count < this._sortedEquipmentList.length;
        se_count++
      ) {
        if (
          this._equipmentList[countEQ].location ===
            this._sortedEquipmentList[se_count].location &&
          this._equipmentList[countEQ].tag ===
            this._sortedEquipmentList[se_count].tag
        ) {
          // @ts-ignore
      ...
      let eqItemSeparate = JSON.parse(
        JSON.stringify(this._equipmentList[countEQ]),
      );
  ...
  private _calcArmorStructureBubbles() {
    ...
    if (this._armorBubbles.head.length > this._armorAllocation.head) {
      this._armorBubbles.head = this._armorBubbles.head.splice(
        0,
        this._armorAllocation.head,
      );
    }

    if (!this._armorBubbles.centerTorso) this._armorBubbles.centerTorso = [];
    while (
      this._armorBubbles.centerTorso.length < this._armorAllocation.centerTorso
    ) {
    ...
    if (
      ...
      this._armorBubbles.centerTorso = this._armorBubbles.centerTorso.splice(
        0,
        this._armorAllocation.centerTorso,
      );
    }

    if (!this._armorBubbles.rightTorso) this._armorBubbles.rightTorso = [];
    while (
      this._armorBubbles.rightTorso.length < this._armorAllocation.rightTorso
    ) {
    ...
    if (
      ...
      this._armorBubbles.rightTorso = this._armorBubbles.rightTorso.splice(
        0,
        this._armorAllocation.rightTorso,
      );
    }
    if (!this._armorBubbles.leftTorso) this._armorBubbles.leftTorso = [];
    while (
      this._armorBubbles.leftTorso.length < this._armorAllocation.leftTorso
    ) {
      this._armorBubbles.leftTorso.push(true);
    }
    if (this._armorBubbles.leftTorso.length > this._armorAllocation.leftTorso) {
      this._armorBubbles.leftTorso = this._armorBubbles.leftTorso.splice(
        0,
        this._armorAllocation.leftTorso,
      );
    }
    ...
    while (
      this._armorBubbles.centerTorsoRear.length <
      this._armorAllocation.centerTorsoRear
    ) {
    ...
    if (
      ...
      this._armorBubbles.centerTorsoRear =
        this._armorBubbles.centerTorsoRear.splice(
          0,
          this._armorAllocation.centerTorsoRear,
        );
    }
    ...
    while (
      this._armorBubbles.rightTorsoRear.length <
      this._armorAllocation.rightTorsoRear
    ) {
    ...
    if (
      ...
      this._armorBubbles.rightTorsoRear =
        this._armorBubbles.rightTorsoRear.splice(
          0,
          this._armorAllocation.rightTorsoRear,
        );
    }
    ...
    while (
      this._armorBubbles.leftTorsoRear.length <
      this._armorAllocation.leftTorsoRear
    ) {
    ...
    if (
      ...
      this._armorBubbles.leftTorsoRear =
        this._armorBubbles.leftTorsoRear.splice(
          0,
          this._armorAllocation.leftTorsoRear,
        );
    }

    if (!this._armorBubbles.leftArm) this._armorBubbles.leftArm = [];
    ...
    if (this._armorBubbles.leftArm.length > this._armorAllocation.leftArm) {
      this._armorBubbles.leftArm = this._armorBubbles.leftArm.splice(
        0,
        this._armorAllocation.leftArm,
      );
    }
    if (!this._armorBubbles.rightArm) this._armorBubbles.rightArm = [];
    while (
      this._armorBubbles.rightArm.length < this._armorAllocation.rightArm
    ) {
      this._armorBubbles.rightArm.push(true);
    }
    if (this._armorBubbles.rightArm.length > this._armorAllocation.rightArm) {
      this._armorBubbles.rightArm = this._armorBubbles.head.splice(
        0,
        this._armorAllocation.rightArm,
      );
    }

    if (!this._armorBubbles.rightLeg) this._armorBubbles.rightLeg = [];
    while (
      this._armorBubbles.rightLeg.length < this._armorAllocation.rightLeg
    ) {
      this._armorBubbles.rightLeg.push(true);
    }
    if (this._armorBubbles.rightLeg.length > this._armorAllocation.rightLeg) {
      this._armorBubbles.rightLeg = this._armorBubbles.rightLeg.splice(
        0,
        this._armorAllocation.rightLeg,
      );
    }
    if (!this._armorBubbles.leftLeg) this._armorBubbles.leftLeg = [];
    ...
    if (this._armorBubbles.leftLeg.length > this._armorAllocation.leftLeg) {
      this._armorBubbles.leftLeg = this._armorBubbles.head.splice(
        0,
        this._armorAllocation.leftLeg,
      );
    }

    if (!this._structureBubbles.head) this._structureBubbles.head = [];
    ...
    if (this._structureBubbles.head.length > this._internalStructure.head) {
      this._structureBubbles.head = this._structureBubbles.head.splice(
        0,
        this._internalStructure.head,
      );
    }
    ...
    while (
      this._structureBubbles.centerTorso.length <
      this._internalStructure.centerTorso
    ) {
    ...
    if (
      ...
      this._structureBubbles.centerTorso =
        this._structureBubbles.centerTorso.splice(
          0,
          this._internalStructure.centerTorso,
        );
    }
    ...
    while (
      this._structureBubbles.rightTorso.length <
      this._internalStructure.rightTorso
    ) {
    ...
    if (
      ...
      this._structureBubbles.rightTorso =
        this._structureBubbles.rightTorso.splice(
          0,
          this._internalStructure.rightTorso,
        );
    }
    ...
    while (
      this._structureBubbles.leftTorso.length <
      this._internalStructure.leftTorso
    ) {
    ...
    if (
      ...
      this._structureBubbles.leftTorso =
        this._structureBubbles.leftTorso.splice(
          0,
          this._internalStructure.leftTorso,
        );
    }
    ...
    if (!this._structureBubbles.leftArm) this._structureBubbles.leftArm = [];
    while (
      this._structureBubbles.leftArm.length < this._internalStructure.leftArm
    ) {
    ...
    if (
      ...
      this._structureBubbles.leftArm = this._structureBubbles.leftArm.splice(
        0,
        this._internalStructure.leftArm,
      );
    }
    if (!this._structureBubbles.rightArm) this._structureBubbles.rightArm = [];
    while (
      this._structureBubbles.rightArm.length < this._internalStructure.rightArm
    ) {
    ...
    if (
      ...
      this._structureBubbles.rightArm = this._structureBubbles.rightArm.splice(
        0,
        this._internalStructure.rightArm,
      );
    }

    if (!this._structureBubbles.rightLeg) this._structureBubbles.rightLeg = [];
    while (
      this._structureBubbles.rightLeg.length < this._internalStructure.rightLeg
    ) {
    ...
    if (
      ...
      this._structureBubbles.rightLeg = this._structureBubbles.rightLeg.splice(
        0,
        this._internalStructure.rightLeg,
      );
    }
    if (!this._structureBubbles.leftLeg) this._structureBubbles.leftLeg = [];
    while (
      this._structureBubbles.leftLeg.length < this._internalStructure.leftLeg
    ) {
    ...
    if (
      ...
      this._structureBubbles.leftLeg = this._structureBubbles.leftLeg.splice(
        0,
        this._internalStructure.leftLeg,
      );
    }
  ...
  private _sortCriticalAllocationTableByTagThenUUID() {
    this._criticalAllocationTable.sort((a: ICriticalSlot, b: ICriticalSlot) => {
      if (a.tag > b.tag) {
        return -1;
      } else if (a.tag < b.tag) {
        return 1;
  ...
  private _calcCriticals() {
    ...
    if (
      ...
      if (engineCrits && engineCrits.ct) {
        if (this._engineType && engineCrits && engineCrits.ct > 3) {
          this._addCriticalItem(
            "engine", // item_tag
        ...
        if (engineCrits && engineCrits.rt) {
          this._addCriticalItem(
            "engine",
            this._engineType.name,
            engineCrits.rt,
            "rt",
          );
        }

        if (engineCrits && engineCrits.lt) {
          this._addCriticalItem(
            "engine",
            this._engineType.name,
            engineCrits.lt,
    ...
    if (this.getTech().tag === "clan") {
      for (
        let aCounter = 0;
        aCounter < this._selectedInternalStructure.crits.clan;
        aCounter++
      ) {
        this._unallocatedCriticals.push({
          uuid: generateUUID(),
      ...
      for (
        let aCounter = 0;
        aCounter < this._selectedInternalStructure.crits.is;
        aCounter++
      ) {
        this._unallocatedCriticals.push({
          uuid: generateUUID(),
    ...
    for (let elc = 0; elc < this._equipmentList.length; elc++) {
      ...
      this._unallocatedCriticals.push({
        //@ts-ignore
        uuid: this._equipmentList[elc].uuid
          ? this._equipmentList[elc].uuid
          : "undefined?",
    ...
    let hs_nickname = "";
    if (hs_requirements.slotsEach > 1) hs_nickname = "Double Heat Sink";
    else hs_nickname = "Heat Sink";
    ...
    for (let item of this._criticalAllocationTable) {
      ...
      if (!criticalTally[item.uuid]) criticalTally[item.uuid] = 0;

      if (item.size) criticalTally[item.uuid] += item.size;
      else criticalTally[item.uuid] += item.crits;

      if (criticalTally[item.uuid] >= item.crits) removeFromUnallocated = true;
  ...
  public hasHandActuator(location: string) {
    if (location === "ra") if (this._no_right_arm_hand_actuator) return false;
    if (location === "la") if (this._no_left_arm_hand_actuator) return false;
    return true;
  }

  public hasLowerArmActuator(location: string) {
    if (location === "ra") if (this._no_right_arm_lower_actuator) return false;
    if (location === "la") if (this._no_left_arm_lower_actuator) return false;
    return true;
  }

  public removeHandActuator(location: string) {
    if (location === "ra") {
  ...
  public removeLowerArmActuator(location: string) {
    if (location === "ra") {
      this._no_right_arm_hand_actuator = true;
  ...
  public addHandActuator(location: string) {
    if (location === "ra") {
  ...
  public addLowerArmActuator(location: string) {
    if (location === "ra") {
  ...
  public toggleHandActuator(location: string) {
    if (location === "ra") {
  ...
  public toggleLowerArmActuator(location: string) {
    if (location === "ra") {
  ...
  private _addCriticalItem(
    ...
    if (typeof slot === "undefined" || slot === null) slot = null;

    if (typeof location !== "undefined" && location !== null) {
      if (location === "hd") {
        return this._assignItemToArea(
  ...
  public setHeatSinksType(newValue: string) {
    for (let heatSink of mechHeatSinkTypes) {
      if (heatSink.tag === newValue) this._heatSinkType = heatSink;
    }

    for (
      let localCount = this._criticalAllocationTable.length;
      localCount >= 0;
      localCount--
    ) {
      if (
        this._criticalAllocationTable[localCount] &&
        this._criticalAllocationTable[localCount].tag === "heat-sink"
      )
  ...
  public getHeatSummary(): number {
    ...
    return (
      this.getMoveHeat() + this.getWeaponHeat() - this.getHeatDissipation()
    );
  }
  ...
  public setWalkSpeed(walkSpeed: number) {
    ...
    if (this._jumpSpeed > this._walkSpeed) this.setJumpSpeed(this._walkSpeed);
  ...
  public setJumpSpeed(jumpSpeed: number) {
  ...
  public setArmorCount(armorCount: number) {
    ...
    if (this.getTech().tag === "clan") {
      ...
      this._armorWeight =
        this._totalArmor / this.getArmorObj().armorMultiplier.clan;
    } else {
      ...
      this._armorWeight =
        this._totalArmor / this.getArmorObj().armorMultiplier.is;
    }
    if (this._armorWeight % 0.5 !== 0) {
  ...
  public setArmorWeight(armorWeight: number) {
  ...
  public setEngine(ratingNumber: number) {
  ...
  public setInternalStructureType(isTag: string) {
  ...
  public toggleCritical(location: string, critSlotIndex: number) {
  ...
  public isCriticalDamaged(location: string, critSlotIndex: number): boolean {
    if (typeof this.criticalDamage[location] === "undefined") {
      this.criticalDamage[location] = [];
    }
  ...
  public setPilotName(newValue: string) {
    this._pilot.name = newValue;
  }

  public setPilotPiloting(newValue: number) {
    this._pilot.piloting = newValue;
    this._calcBattleValue();
  }

  public setPilotGunnery(newValue: number) {
    this._pilot.gunnery = newValue;
    this._calcBattleValue();
  }

  public setEngineType(engineTag: string) {
  ...
  public setGyroTypeByName(gyroName: string) {
    for (let gyro of mechGyroTypes) {
      if (
        gyroName.toLowerCase().trim() === gyro.name.toLowerCase().trim() ||
        (gyro.alternateName &&
          gyroName.toLowerCase().trim() ===
            gyro.alternateName.toLowerCase().trim())
      ) {
        this._gyro = gyro;
        this._calc();
        return this._gyro;
  ...
  public setEngineTypeByName(engineName: string) {
    for (let engine of mechEngineTypes) {
      if (
        engineName.toLowerCase().trim() === engine.name.toLowerCase().trim() ||
        (engine.alternateName &&
          engineName.toLowerCase().trim() ===
            engine.alternateName.toLowerCase().trim())
      ) {
        this._engineType = engine;
        this._calc();
        return this._engineType;
  ...
  getName() {
    ...
    if (this._nickname && this._nickname.trim()) {
      ...
      if (this._model && this._model.trim()) return this._model.trim() + name;
      else return "" + name;
    }
  }

  public setModel(newValue: string): string {
  ...
  public isUnderStrength(): boolean {
    ...
    if (this.pilot.wounds > 0) return true;
  ...
  public setName(newValue: string): string {
    this._name = newValue;
    return this._name;
  }
  ...
  public setTonnage(tonnage: number) {
    this._tonnage = tonnage;
    this._internalStructure.head =
      this._selectedInternalStructure.perTon[this.getTonnage()].head;

    this._internalStructure.centerTorso =
      this._selectedInternalStructure.perTon[this.getTonnage()].centerTorso;
    this._internalStructure.leftTorso =
      this._selectedInternalStructure.perTon[this.getTonnage()].rlTorso;
    this._internalStructure.rightTorso =
      this._selectedInternalStructure.perTon[this.getTonnage()].rlTorso;

    this._internalStructure.rightArm =
      this._selectedInternalStructure.perTon[this.getTonnage()].rlArm;
    this._internalStructure.leftArm =
      this._selectedInternalStructure.perTon[this.getTonnage()].rlArm;

    this._internalStructure.rightLeg =
      this._selectedInternalStructure.perTon[this.getTonnage()].rlLeg;
    this._internalStructure.leftLeg =
      this._selectedInternalStructure.perTon[this.getTonnage()].rlLeg;
    ...
    if (this._mechType.tag.toLowerCase() === "biped")
      this._maxArmor +=
        this._internalStructure.leftArm * 2 +
        this._internalStructure.rightArm * 2;
    else
      this._maxArmor +=
        this._internalStructure.rightLeg * 2 +
        this._internalStructure.leftLeg * 2;
  ...
  public setType(typeTag: string) {
    for (let mechType of mechTypeOptions) {
      if (mechType.tag === typeTag) {
        ...
        this.setTonnage(this._tonnage);
        if (typeTag === "quad") this._clearArmCriticalAllocationTable();
        this._calc();
        return this._mechType;
      }
    }
  ...
  public exportJSON(noInPlayVariables: boolean = false): string {
    return JSON.stringify(this.export(noInPlayVariables));
  }

  public getTargetSummaryText(target: string): string {
  ...
  public export(noInPlayVariables: boolean = false): IBattleMechExport {
    this._calc();
    ...
    let thinnedAllocations: ICriticalSlot[] = JSON.parse(
      JSON.stringify(this._criticalAllocationTable),
    );
    ...
    for (let countEQ = 0; countEQ < this._equipmentList.length; countEQ++) {
      if (noInPlayVariables) {
        exportObject.equipment.push({
          ...
          allocationIndex:
            typeof this._equipmentList[countEQ].allocationIndex !== "undefined"
              ? this._equipmentList[countEQ].allocationIndex
              : -1,
          //@ts-ignore - yet another TS failure
          allocationLocation:
            typeof this._equipmentList[countEQ].allocationLocation !==
            "undefined"
              ? this._equipmentList[countEQ].allocationLocation
              : "",
    ...
    if (!this.hasLowerArmActuator("la")) exportObject.features.push("no_lala");
    if (!this.hasLowerArmActuator("ra")) exportObject.features.push("no_rala");
    if (!this.hasHandActuator("la")) exportObject.features.push("no_laha");
    if (!this.hasHandActuator("ra")) exportObject.features.push("no_raha");
    if (this._smallCockpit) exportObject.features.push("sm_cockpit");
  ...
  public setASRole(newValue: string) {
  ...
  public setASCustomName(newValue: string) {
  ...
  public cycleWeaponTarget(weaponIndex: number) {
  ...
  import(importObject: IBattleMechExport) {
    ...
    if (importObject && importObject.currentToHitMovementModifier) {
      this.currentToHitMovementModifier =
        importObject.currentToHitMovementModifier;
    }
    ...
    if (importObject && importObject.mechType) {
      if (importObject.name) this.setName(importObject.name);
      if (importObject.model) this.setModel(importObject.model);

      // console.log( "importObject.mechType", importObject.mechType );
      if (importObject.mechType) this.setMechType(importObject.mechType);
      ...
      if (importObject.era) this.setEra(importObject.era);

      if (importObject.tech) this.setTech(importObject.tech);

      if (importObject.pilot) this._pilot = new Pilot(importObject.pilot);

      if (importObject.as_role) this.setASRole(importObject.as_role);

      if (importObject.armor_type) this.setArmorType(importObject.armor_type);
      ...
      if (importObject.walkSpeed) this.setWalkSpeed(importObject.walkSpeed);

      if (importObject.jumpSpeed) this.setJumpSpeed(importObject.jumpSpeed);

      if (typeof importObject.strictEra !== "undefined") {
        if (importObject.strictEra) this._strictEra = true;
        else this._strictEra = false;
      }

      if (importObject.gyro) this.setGyroType(importObject.gyro);

      if (importObject.engineType) this.setEngineType(importObject.engineType);
      ...
      if (importObject.uuid) this._uuid = importObject.uuid;

      this._nickname = "";
      if (importObject.nickname) this._nickname = importObject.nickname;
      ...
      if (importObject.equipment) {
        for (
          let countEQ = 0;
          countEQ < importObject.equipment.length;
          countEQ++
        ) {
          let importItem = importObject.equipment[countEQ];

          if (importItem.rear) importItem.rear = true;
          else importItem.rear = false;
      ...
      if (importObject.allocation) {
        importObject.allocation.sort((a, b) => {
          if (a.uuid > b.uuid) {
            return -1;
          } else if (a.uuid < b.uuid) {
            return 1;
        ...
        for (
          let countEQ = 0;
          countEQ < this._criticalAllocationTable.length;
          countEQ++
        ) {
          this._criticalAllocationTable[countEQ].obj = this.getEquipmentByUUID(
            this._criticalAllocationTable[countEQ].uuid,
          );

          if (this._criticalAllocationTable[countEQ].rear)
            this._criticalAllocationTable[countEQ].rear = true;
          else this._criticalAllocationTable[countEQ].rear = false;

          if (this._criticalAllocationTable[countEQ].damaged)
            this._criticalAllocationTable[countEQ].damaged = true;
          else this._criticalAllocationTable[countEQ].damaged = false;
        }
      }
  ...
  getEquipmentByUUID(uuid: string): IEquipmentItem | null {
  ...
  public setLeftLegArmor(armorValue: number) {
  ...
  public setLeftTorsoArmor(armorValue: number) {
  ...
  public setLeftTorsoRearArmor(armorValue: number) {
  ...
  public setRightArmArmor(armorValue: number) {
    this._armorAllocation.rightArm = armorValue;
    if (this._mirrorArmorAllocations) {
      this._armorAllocation.leftArm = armorValue;
    }
  ...
  public setRightLegArmor(armorValue: number) {
    this._armorAllocation.rightLeg = armorValue;
    if (this._mirrorArmorAllocations) {
      this._armorAllocation.leftLeg = armorValue;
    }
  ...
  public setRightTorsoArmor(armorValue: number) {
    this._armorAllocation.rightTorso = armorValue;
    if (this._mirrorArmorAllocations) {
      this._armorAllocation.leftTorso = armorValue;
    }
  ...
  public setRightTorsoRearArmor(armorValue: number) {
    this._armorAllocation.rightTorsoRear = armorValue;
    if (this._mirrorArmorAllocations) {
      this._armorAllocation.leftTorsoRear = armorValue;
    }
  ...
  public addEquipment(
    ...
    if (equipmentList[equipmentIndex]) {
      let equipmentItem: IEquipmentItem = JSON.parse(
        JSON.stringify(equipmentList[equipmentIndex]),
      );

      if (typeof location !== "undefined") equipmentItem.location = location;

      if (typeof weight !== "undefined") equipmentItem.weight = weight;
  ...
  public addEquipmentByName(
    ...
    for (let item of equipmentList) {
      if (
        ...
        (item.alternateName &&
          item.alternateName.toLowerCase().trim() ===
            equipmentName.toLowerCase().trim())
      ) {
        ...
        if (
          equipmentItem.criticalsDivisor &&
          equipmentItem.criticalsDivisor > -1
        ) {
          equipmentItem.criticals =
            this.getTonnage() / equipmentItem.criticalsDivisor;
        }

        if (equipmentItem.weightDivisor && equipmentItem.weightDivisor > -1) {
          equipmentItem.weight =
            this.getTonnage() / equipmentItem.weightDivisor;
        }
  ...
  public removeEquipment(itemUUID: string | undefined) {
    if (itemUUID) {
      for (let equipmentIndex in this._equipmentList) {
        if (
          this._equipmentList[equipmentIndex] &&
          itemUUID === this._equipmentList[equipmentIndex].uuid
        ) {
  ...
  private _returnRandomString(from: string[]): string {
  ...
  public hasXLEngine(): boolean {
    if (
      this._engineType &&
      this._engineType.criticals &&
      ((this._engineType.criticals.clan &&
        this._engineType.criticals.clan.lt &&
        this._engineType.criticals.clan.lt > 0) ||
        (this._engineType.criticals.clan &&
          this._engineType.criticals.clan.rt &&
          this._engineType.criticals.clan.rt > 0) ||
        (this._engineType.criticals.is &&
          this._engineType.criticals.is.lt &&
          this._engineType.criticals.is.lt > 0) ||
        (this._engineType.criticals.is &&
          this._engineType.criticals.is.rt &&
          this._engineType.criticals.is.rt > 0))
    ) {
      return true;
    }
  ...
  public isWreckedBlurb(): string {
    ...
    if (this.sensorHits() > 1) {
      let damageSnarks: string[] = ["I can't see!"];
      return this._returnRandomString(damageSnarks);
    }
  ...
  public takeDamage(
    ...
    if (locationHasArmor) {
      ...
      if (remainderDamage) {
        ...
        remainderDamage = this._takeStructureDamageAtLocation(
          location,
          remainderDamage,
        );
        while (
      ...
      let remainderDamage = this._takeStructureDamageAtLocation(
        location,
        amount,
      );
      while (
  ...
  private _locationHasArmor(location: string): boolean {
    if (this._armorInLocation(location) > 0) return true;

    return false;
  }

  private _locationHasStructure(location: string): boolean {
    if (this._structureInLocation(location) > 0) return true;
  ...
  private _takeArmorDamageAtLocation(location: string, amount: number): number {
    ...
    if (location === "ct") {
      for (let bubbleIndex in this._armorBubbles.centerTorso) {
        if (
          this._armorBubbles.centerTorso[bubbleIndex] &&
          damageTaken < amount
        ) {
      ...
      for (let bubbleIndex in this._armorBubbles.centerTorsoRear) {
        if (
          this._armorBubbles.centerTorsoRear[bubbleIndex] &&
          damageTaken < amount
        ) {
      ...
      for (let bubbleIndex in this._armorBubbles.leftTorsoRear) {
        if (
          this._armorBubbles.leftTorsoRear[bubbleIndex] &&
          damageTaken < amount
        ) {
      ...
      for (let bubbleIndex in this._armorBubbles.rightTorso) {
        if (
          this._armorBubbles.rightTorso[bubbleIndex] &&
          damageTaken < amount
        ) {
      ...
      for (let bubbleIndex in this._armorBubbles.rightTorsoRear) {
        if (
          this._armorBubbles.rightTorsoRear[bubbleIndex] &&
          damageTaken < amount
        ) {
  ...
  private _takeStructureDamageAtLocation(
    ...
    if (location === "ct" || location === "ctr") {
      for (let bubbleIndex in this._structureBubbles.centerTorso) {
        if (
          this._structureBubbles.centerTorso[bubbleIndex] &&
          damageTaken < amount
        ) {
      ...
      for (let bubbleIndex in this._structureBubbles.leftTorso) {
        if (
          this._structureBubbles.leftTorso[bubbleIndex] &&
          damageTaken < amount
        ) {
      ...
      for (let bubbleIndex in this._structureBubbles.rightTorso) {
        if (
          this._structureBubbles.rightTorso[bubbleIndex] &&
          damageTaken < amount
        ) {
      ...
      for (let bubbleIndex in this._structureBubbles.rightArm) {
        if (
          this._structureBubbles.rightArm[bubbleIndex] &&
          damageTaken < amount
        ) {
      ...
      for (let bubbleIndex in this._structureBubbles.leftArm) {
        if (
          this._structureBubbles.leftArm[bubbleIndex] &&
          damageTaken < amount
        ) {
      ...
      for (let bubbleIndex in this._structureBubbles.leftLeg) {
        if (
          this._structureBubbles.leftLeg[bubbleIndex] &&
          damageTaken < amount
        ) {
      ...
      for (let bubbleIndex in this._structureBubbles.rightLeg) {
        if (
          this._structureBubbles.rightLeg[bubbleIndex] &&
          damageTaken < amount
        ) {
  ...
  public setweight(itemUUID: string | undefined, weight: number) {
    if (itemUUID) {
  ...
  public setRear(itemUUID: string | undefined, newValue: boolean) {
    if (itemUUID) {
      for (let item of this._equipmentList) {
        if (item.uuid && item.uuid === itemUUID) {
          item.rear = newValue;
  ...
  private _updateCriticalAllocationTable() {
    ...
    for (let mechLocation of Object.keys(this._criticals)) {
      ...
      if (this._criticals[mechLocation]) {
        for (
          let critItemCounter = 0;
          critItemCounter < this._criticals[mechLocation].length;
          critItemCounter++
        ) {
  ...
  _removeUUIDFromUnallocated(uuid: string) {
    for (
      let index = this._unallocatedCriticals.length - 1;
      index > -1;
      index--
    ) {
      if (
        this._unallocatedCriticals[index] &&
        uuid === this._unallocatedCriticals[index].uuid
      ) {
  ...
  private _moveItemToArea(
    ...
    if (toIndex === -1) {
      for (let itemIndex = 0; itemIndex < toLocation.length; itemIndex++) {
        if (
          toLocation[itemIndex] === null ||
          typeof toLocation[itemIndex] === "undefined"
        ) {
          toIndex = +itemIndex;
          break;
        }
      ...
      if (toIndex === -1) {
        let numSlots = 12;
        if (toLocTag === "ll" || toLocTag === "rl" || toLocTag === "hd") {
          numSlots = 6;
        }
    ...
    if (toLocation.length < toIndex + toSize || toIndex < 0) return false;
  ...
  private _allocateCritical(
    ...
    if (mechLocation && typeof slotNumber !== "undefined") {
      for (
        let uaet_c = 0;
        uaet_c < this._unallocatedCriticals.length;
        uaet_c++
      ) {
        if (
          ...
          if (
            ...
            this._unallocatedCriticals[uaet_c].obj
          )
  ...
  private _clearArmCriticalAllocationTable() {
    for (
      ...
      if (
        (this._criticalAllocationTable[localCount] &&
          this._criticalAllocationTable[localCount].loc === "ra") ||
        (this._criticalAllocationTable[localCount] &&
          this._criticalAllocationTable[localCount].loc === "la")
      ) {
        this._criticalAllocationTable.splice(localCount, 1);
      }
    }
  ...
  public setAdditionalHeatSinks(newValue: number) {
    ...
    for (let eqC = 0; eqC < this._equipmentList.length; eqC++) {
      if (this._equipmentList[eqC] && this._equipmentList[eqC].variableSize) {
        ...
        if (currentItem.criticalsDivisor) {
          currentItem.criticals = Math.ceil(
            this.getTonnage() / currentItem.criticalsDivisor,
          );
        }

        if (currentItem.weightDivisor) {
          currentItem.weight = Math.ceil(
            this.getTonnage() / currentItem.weightDivisor,
          );
        }

        if (currentItem.damageDivisor) {
          currentItem.damage = Math.ceil(
            this.getTonnage() / currentItem.damageDivisor,
          );
        }
        ...
        if (currentItem.criticalsDivisor) {
          currentItem.space.battlemech = Math.ceil(
            this.getTonnage() / currentItem.criticalsDivisor,
          );
        }
        ...
        if (currentItem.battleValuePerItemDamage && currentItem.damage) {
          currentItem.battleValue =
            currentItem.battleValuePerItemDamage * +currentItem.damage;
        }
  ...
  public getAvailableGyros(): IGyro[] {
    ...
    for (let gyro of mechGyroTypes) {
      gyro.available = this._itemIsAvailable(
        gyro.introduced,
        gyro.extinct,
        gyro.reintroduced,
      );
  ...
  public getAvailableArmorTypes(): IArmorType[] {
    ...
    for (let armor of mechArmorTypes) {
      armor.available = this._itemIsAvailable(
        armor.introduced,
        armor.extinct,
        armor.reintroduced,
      );
  ...
  public allocateArmorSane() {
    ...
    let torsoArmor = Math.floor(
      internalStructure.rightTorso * 1.75 * percentage,
    );
    let legArmor = Math.floor(internalStructure.rightLeg * 2 * percentage);
    let rearArmor = Math.floor(
      internalStructure.rightTorso * 0.25 * percentage,
    );

    let centerTorsoArmor = Math.floor(
      internalStructure.centerTorso * 1.75 * percentage,
    );
    let centerTorsoArmorRear = Math.floor(
      internalStructure.centerTorso * 0.25 * percentage,
    );
  ...
  public allocateArmorMax() {
    this._armorAllocation = {
      ...
      centerTorsoRear: Math.floor(
        (this.getInteralStructure().centerTorso * 1) / 3,
      ),
      rightTorsoRear: Math.floor(
        (this.getInteralStructure().rightTorso * 1) / 3,
      ),
  ...
  public getMaxCenterTorsoRearArmor(): number {
    return (
      this.getInteralStructure().centerTorso * 2 -
      this.getArmorAllocation().centerTorso
    );
  }
  public getMaxCenterTorsoArmor(): number {
    return (
      this.getInteralStructure().centerTorso * 2 -
      this.getArmorAllocation().centerTorsoRear
    );
  }

  public getMaxRightTorsoRearArmor(): number {
    return (
      this.getInteralStructure().rightTorso * 2 -
      this.getArmorAllocation().rightTorso
    );
  }
  public getMaxRightTorsoArmor(): number {
    return (
      this.getInteralStructure().rightTorso * 2 -
      this.getArmorAllocation().rightTorsoRear
    );
  }

  public getMaxLeftTorsoRearArmor(): number {
    return (
      this.getInteralStructure().leftTorso * 2 -
      this.getArmorAllocation().leftTorso
    );
  }
  public getMaxLeftTorsoArmor(): number {
    return (
      this.getInteralStructure().leftTorso * 2 -
      this.getArmorAllocation().leftTorsoRear
    );
  }
  ...
  public getAvailableEquipment(): IEquipmentItem[] {
    ...
    if (this.getTech().tag === "clan") {
      for (let item of mechClanEquipmentEnergy) {
        ...
        item.available = this._itemIsAvailable(
          item.introduced,
          item.extinct,
          item.reintroduced,
        );
  ...
  public lifeSupportHits(): number {
    ...
    for (let critIndex in this._criticals.head) {
      if (
        ...
        this._criticals.head[critIndex].name
          .toLowerCase()
          .startsWith("life support") &&
  ...
  public toggleISBubble(clickLocation: string, clickIndex: number): void {
    switch (clickLocation) {
      case "hd": {
        this._structureBubbles.head[clickIndex] =
          !this._structureBubbles.head[clickIndex];
        break;
      }

      case "rt": {
        this._structureBubbles.rightTorso[clickIndex] =
          !this._structureBubbles.rightTorso[clickIndex];
        break;
      }
      case "ct": {
        this._structureBubbles.centerTorso[clickIndex] =
          !this._structureBubbles.centerTorso[clickIndex];
        break;
      }
      case "lt": {
        this._structureBubbles.leftTorso[clickIndex] =
          !this._structureBubbles.leftTorso[clickIndex];
        break;
      }

      case "ra": {
        this._structureBubbles.rightArm[clickIndex] =
          !this._structureBubbles.rightArm[clickIndex];
        break;
      }
      case "la": {
        this._structureBubbles.leftArm[clickIndex] =
          !this._structureBubbles.leftArm[clickIndex];
        break;
      }

      case "rl": {
        this._structureBubbles.rightLeg[clickIndex] =
          !this._structureBubbles.rightLeg[clickIndex];
        break;
      }
      case "ll": {
        this._structureBubbles.leftLeg[clickIndex] =
          !this._structureBubbles.leftLeg[clickIndex];
        break;
      }
    }
  ...
  public toggleArmorBubble(clickLocation: string, clickIndex: number): void {
    switch (clickLocation) {
      case "hd": {
        this._armorBubbles.head[clickIndex] =
          !this._armorBubbles.head[clickIndex];
        break;
      }

      case "rt": {
        this._armorBubbles.rightTorso[clickIndex] =
          !this._armorBubbles.rightTorso[clickIndex];
        break;
      }
      case "ct": {
        this._armorBubbles.centerTorso[clickIndex] =
          !this._armorBubbles.centerTorso[clickIndex];
        break;
      }
      case "lt": {
        this._armorBubbles.leftTorso[clickIndex] =
          !this._armorBubbles.leftTorso[clickIndex];
        break;
      }

      case "ra": {
        this._armorBubbles.rightArm[clickIndex] =
          !this._armorBubbles.rightArm[clickIndex];
        break;
      }
      case "la": {
        this._armorBubbles.leftArm[clickIndex] =
          !this._armorBubbles.leftArm[clickIndex];
        break;
      }

      case "rl": {
        this._armorBubbles.rightLeg[clickIndex] =
          !this._armorBubbles.rightLeg[clickIndex];
        break;
      }
      case "ll": {
        this._armorBubbles.leftLeg[clickIndex] =
          !this._armorBubbles.leftLeg[clickIndex];
        break;
      }

      case "rtr": {
        this._armorBubbles.rightTorsoRear[clickIndex] =
          !this._armorBubbles.rightTorsoRear[clickIndex];
        break;
      }
      case "ctr": {
        this._armorBubbles.centerTorsoRear[clickIndex] =
          !this._armorBubbles.centerTorsoRear[clickIndex];
        break;
      }
      case "ltr": {
        this._armorBubbles.leftTorsoRear[clickIndex] =
          !this._armorBubbles.leftTorsoRear[clickIndex];
        break;
      }
    }
  ...
  public importTRO(importString: string): void {
    ...
    for (let line of lines) {
      if (line.toLowerCase().startsWith("technology base:")) {
        line = line.replace(/technology base:/gi, "").trim();
      ...
      if (line.toLowerCase().startsWith("tonnage: ")) {
        line = line.replace(/tonnage: /gi, "").trim();
        if (+line) {
          this.setTonnage(+line);
        }
      }
      if (line.toLowerCase().startsWith("type: ")) {
        line = line.replace(/type:/gi, "").trim();
        if (line) {
          this.setModel(line);
        }
      }
      if (line.toLowerCase().startsWith("walking mp: ")) {
        line = line.replace(/walking mp:/gi, "").trim();
        if (+line) {
          this.setWalkSpeed(+line);
        }
      }
      if (line.toLowerCase().startsWith("jumping mp: ")) {
        line = line.replace(/jumping mp:/gi, "").trim();
        if (+line) {
      ...
      if (line.toLowerCase().startsWith("double heat sinks: ")) {
        line = line.replace(/double heat sink:/gi, "").trim();
        if (line && line.indexOf(" ") > -1) {
          line = line.replace(/ {2}/gi, " ").trim();
      ...
      if (line.toLowerCase().startsWith("single heat sinks: ")) {
        line = line.replace(/single heat sinks:/gi, "").trim();
        if (line && line.indexOf(" ") > -1) {
          line = line.replace(/ {2}/gi, " ").trim();
          let splitLine = line.split(" ");
      ...
      if (line.toLowerCase().startsWith("heat sinks: ")) {
        line = line.replace(/heat sinks:/gi, "").trim();
        if (line && line.indexOf(" ") > -1) {
          line = line.replace(/ {2}/gi, " ").trim();
          let splitLine = line.split(" ");
      ...
      if (line.toLowerCase().startsWith("armor factor: ")) {
        line = line.replace(/armor factor:/gi, "").trim();
        if (line && line.indexOf(" ") > -1) {
          line = line.replace(/ {2}/gi, " ").trim();
          let splitLine = line.split(" ");
      ...
      if (line.toLowerCase().startsWith("head")) {
        line = line.replace(/head/gi, "").trim();
        if (line && line.indexOf(" ") > -1) {
          line = line.replace(/ {2}/gi, " ").trim();
          let splitLine = line.split(" ");
      ...
      if (
        line.toLowerCase().startsWith("center torso") &&
        line.toLowerCase().indexOf("(rear)") === -1
      ) {
        line = line.replace(/center torso/gi, "").trim();
        if (line && line.indexOf(" ") > -1) {
          line = line.replace(/ {2}/gi, " ").trim();
          let splitLine = line.split(" ");
      ...
      if (
        ...
        line = line.replace(/center torso \(rear\)/gi, "").trim();
      ...
      if (
        line.toLowerCase().startsWith("r/l torso") &&
        line.toLowerCase().indexOf("(rear)") === -1
      ) {
        line = line.replace(/r\/l torso/gi, "").trim();
        if (line && line.indexOf(" ") > -1) {
          line = line.replace(/ {2}/gi, " ").trim();
          let splitLine = line.split(" ");
      ...
      if (
        ...
        line = line.replace(/r\/l torso \(rear\)/gi, "").trim();
      ...
      if (line.toLowerCase().startsWith("r/l leg")) {
        line = line.replace(/r\/l leg/gi, "").trim();
        if (line && line.indexOf(" ") > -1) {
          line = line.replace(/ {2}/gi, " ").trim();
          let splitLine = line.split(" ");
      ...
      if (line.toLowerCase().startsWith("r/l arm")) {
        line = line.replace(/r\/l arm/gi, "").trim();
        if (line && line.indexOf(" ") > -1) {
          line = line.replace(/ {2}/gi, " ").trim();
          let splitLine = line.split(" ");
      ...
      if (inEquipmentList && equipmentList.length > 0) {
        ...
        if (
          ...
          if (
            ...
            if (
              equipmentLine.name.trim().toLowerCase().startsWith("jump jet")
            ) {
              for (let count = 0; count < equipmentLine.criticals; count++) {
                for (
                  let critIndex = this._unallocatedCriticals.length - 1;
                  critIndex > -1;
                  critIndex--
                ) {
                  if (
                    this._unallocatedCriticals[critIndex] &&
                    this._unallocatedCriticals[critIndex].name
                      .trim()
                      .toLowerCase()
                      .indexOf("jump jet") > 1
                  ) {
              ...
              for (let eqIndex in equipmentList) {
                ...
                if (
                  eq.name.toLowerCase().trim() ===
                    equipmentLine.name.trim().toLowerCase() ||
                  eq.name.toLowerCase().trim() + "s" ===
                    equipmentLine.name.trim().toLowerCase()
                ) {
  ...
  public set introductoryRules(nv: boolean) {
  ...
  public set hideNonAvailableEquipment(nv: boolean) {
  ...
  public set equipmentList(nv: IEquipmentItem[]) {
  ...
  public getTarget(targetLetter: string) {
    if (targetLetter === "b") {
  ...
  public getMovementText(): string {
    if (this.currentMovementMode) {
      if (this.currentMovementMode === "n") {
        ...
        return (
          "Walked " +
          getHexDistanceFromModifier(this.currentToHitMovementModifier) +
          "⬣"
        );
  ...
  public getMovementToHitText(): string {
    if (this.currentMovementMode) {
      if (this.currentMovementMode === "n") {
        ...
        return (
          "+1 to attack, -" + this.getMovementToHitModifier() + " to be hit"
        );
      } else if (this.currentMovementMode === "r") {
        return (
          "+2 to attack, -" + this.getMovementToHitModifier() + " to be hit"
        );
      } else {
        return (
          "+3 to attack, -" + this.getMovementToHitModifier() + " to be hit"
        );
      }
    } else {
  ...
  public getCurrentArmor(): number {
    ...
    for (
      let count = 0;
      count < this._armorBubbles.centerTorso.length;
      count++
    ) {
    ...
    for (
      let count = 0;
      count < this._armorBubbles.leftTorsoRear.length;
      count++
    ) {
    ...
    for (
      let count = 0;
      count < this._armorBubbles.centerTorsoRear.length;
      count++
    ) {
    ...
    for (
      let count = 0;
      count < this._armorBubbles.rightTorsoRear.length;
      count++
    ) {
  ...
  public getCurrentStructure(): number {
    ...
    for (
      let count = 0;
      count < this._structureBubbles.leftTorso.length;
      count++
    ) {
    ...
    for (
      let count = 0;
      count < this._structureBubbles.centerTorso.length;
      count++
    ) {
    ...
    for (
      let count = 0;
      count < this._structureBubbles.rightTorso.length;
      count++
    ) {
    ...
    for (
      let count = 0;
      count < this._structureBubbles.rightLeg.length;
      count++
    ) {
    ...
    for (
      let count = 0;
      count < this._structureBubbles.rightArm.length;
      count++
    ) {
    ...
    for (
      let count = 0;
      count < this._structureBubbles.leftLeg.length;
      count++
    ) {
    ...
    for (
      let count = 0;
      count < this._structureBubbles.leftArm.length;
      count++
    ) {
  ...
  public selectAmmoBin(weaponUUID: string, ammoUUID: string) {
    for (let eq of this._equipmentList) {
  ...
  public toggleResolved(eq_index: number) {
    if (this._equipmentList.length > eq_index) {
      this._equipmentList[eq_index].resolved =
        !this._equipmentList[eq_index].resolved;
      if (this._equipmentList[eq_index].selectedAmmoBinUUID) {
        if (this._equipmentList[eq_index].resolved)
          this._decrementAmmoBin(
            this._equipmentList[eq_index].selectedAmmoBinUUID,
          );
        else
          this._incrementAmmoBin(
            this._equipmentList[eq_index].selectedAmmoBinUUID,
          );
      }
    }
    ...
    if (uuid) {
      for (let eq of this._equipmentList) {
        if (
          eq.uuid === uuid &&
          eq.isAmmo &&
          typeof eq.currentAmmo !== "undefined" &&
          eq.currentAmmo > 0
        ) {
          eq.currentAmmo--;
        }
  ...
  public setDamageClusterHits(eq_index: number, nv: IClusterHit[]) {
    if (this._equipmentList.length > eq_index) {
      this._equipmentList[eq_index].damageClusterHits = nv;
    }
  }

  private _installSSWEquipment(item: any) {
    let listTag = "is";
    let itemName = "";
    let location = "";
    ...
    if (itemName) {
      ...
      if (!newItem) {
        ...
        this._sswImportErrors.push(
          "Cannot find any equipment named: '" + itemName + "'",
        );
      } else {
        if (halfTon) {
          newItem.weight = 0.5;
  ...
  public getCriticalsForLocation(shortLoc: string): ICriticalSlot[] {
  ...
  public importSSWXML(ssw_xml: string): void {
    ...
    if (jObj && jObj.mech && jObj.mech.mech_type === "BattleMech") {
      ...
      if (jObj.mech.techbase && jObj.mech.techbase["#text"]) {
        if (jObj.mech.techbase["#text"].toLowerCase().indexOf("inner") > -1) {
          ...
          jObj.mech.techbase["#text"].toLowerCase().indexOf("clan") > -1
        ) {
          this.setTech("clan");
        }
      }
      ...
      if (jObj.mech.baseloadout) {
        if (jObj.mech.baseloadout.actuators) {
          if (
            jObj.mech.baseloadout.actuators["@_lh"] &&
            jObj.mech.baseloadout.actuators["@_lh"].toLowerCase().trim() !==
              "true"
          ) {
            this.removeHandActuator("la");
          } else {
          ...
          if (
            jObj.mech.baseloadout.actuators["@_lla"] &&
            jObj.mech.baseloadout.actuators["@_lla"].toLowerCase().trim() !==
              "true"
          ) {
            this.removeLowerArmActuator("la");
          } else {
          ...
          if (
            jObj.mech.baseloadout.actuators["@_rh"] &&
            jObj.mech.baseloadout.actuators["@_rh"].toLowerCase().trim() !==
              "true"
          ) {
            this.removeHandActuator("ra");
          } else {
          ...
          if (
            jObj.mech.baseloadout.actuators["@_rla"] &&
            jObj.mech.baseloadout.actuators["@_rla"].toLowerCase().trim() !==
              "true"
          ) {
            this.removeLowerArmActuator("ra");
          } else {
            ...
            for (let loc of jObj.mech.armor.location) {
              ...
              for (let critItemIndex in this._unallocatedCriticals) {
                if (
                  ...
                  this._unallocatedCriticals[critItemIndex].tag ===
                    this.getArmorType()
                ) {
      ...
      if (jObj.mech.baseloadout) {
        ...
        if (
          jObj.mech.baseloadout.equipment &&
          jObj.mech.baseloadout.equipment.length > 0
        ) {
          ...
          for (let item of this._equipmentList) {
            ...
            for (let critItemIndex in this._unallocatedCriticals) {
              if (
                this._unallocatedCriticals[critItemIndex] &&
                this._unallocatedCriticals[critItemIndex].tag === item.tag
              ) {
                foundIndex = +critItemIndex;
                break;
              }
        ...
        if (jObj.mech.baseloadout.heatsinks) {
          if (
            jObj.mech.baseloadout.heatsinks["type"]
              .toLowerCase()
              .indexOf("single") > -1
          )
            this.setHeatSinksType("single");
          ...
          this.setAdditionalHeatSinks(
            +jObj.mech.baseloadout.heatsinks["@_number"] - 10,
          );
          ...
          if (typeof jObj.mech.baseloadout.heatsinks.location === "object") {
            ...
            try {
              ...
              for (let critItemIndex in this._unallocatedCriticals) {
                if (
                  this._unallocatedCriticals[critItemIndex] &&
                  this._unallocatedCriticals[critItemIndex].tag === "heat-sink"
                ) {
                  foundIndex = +critItemIndex;
                  break;
                }
              ...
              if (foundIndex > -1) {
                this.moveCritical(
                  "un",
                  foundIndex,
                  jObj.mech.baseloadout.heatsinks.location["#text"]
                    ? jObj.mech.baseloadout.heatsinks.location["#text"]
                        .toLowerCase()
                        .trim()
                    : "un",
                  jObj.mech.baseloadout.heatsinks.location["@_index"]
                    ? +jObj.mech.baseloadout.heatsinks.location["@_index"]
                    : -1,
                );
              }
        ...
        if (jObj.mech.baseloadout.jumpjets) {
          ...
          if (
            jObj.mech.baseloadout.jumpjets.type &&
            jObj.mech.baseloadout.jumpjets.type
              .toLowerCase()
              .indexOf("improved") > -1
          ) {
          ...
          for (let loc of jObj.mech.baseloadout.jumpjets.location) {
            ...
            for (let critItemIndex in this._unallocatedCriticals) {
              if (
                this._unallocatedCriticals[critItemIndex] &&
                this._unallocatedCriticals[critItemIndex].tag === jjType
              ) {
                foundIndex = +critItemIndex;
                break;
              }
      ...
      if (this._unallocatedCriticals && this._unallocatedCriticals.length > 0) {
        this.sswImportErrors.push(
          "Unallocated Criticals: " + this._unallocatedCriticals.length,
        );
  ...
  public isNotOnTorsoHeadOrLegs(loc: string | undefined): boolean {
    if (
      loc &&
      (loc === "ct" ||
        loc === "lt" ||
  ...
  private _getToLocationFromTag(fromLocation: string): ICriticalSlot[] {
    if (fromLocation === "un") {
      return this._unallocatedCriticals;
    } else if (fromLocation === "hd") {
      return this._criticals.head;
...
function sortByAdjustedBVThenHeat(
  ...
  if (
    mech &&
    a.rear &&
    mech.getTotalBVFrontWeapons() >= mech.getTotalBVRearWeapons()
  ) {
  ...
  if (aBattleValue < bBattleValue) return 1;
  if (aBattleValue > bBattleValue) return -1;
...
function sortByLocationThenName(a: IEquipmentItem, b: IEquipmentItem) {
  if (a.location && b.location && a.location > b.location) return 1;
  if (a.location && b.location && a.location < b.location) return -1;
