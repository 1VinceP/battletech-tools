...
export function calculateAlphaStrikeValue(
  ...
  if (
    _alphaStrikeForceStats.damage.short.toString() !== "0*" &&
    _alphaStrikeForceStats.damage.short.toString() !== "-"
  )
    offensive_value += +_alphaStrikeForceStats.damage.short;
  if (
    _alphaStrikeForceStats.damage.medium.toString() !== "0*" &&
    _alphaStrikeForceStats.damage.medium.toString() !== "-"
  )
  ...
  if (
    ...
    offensive_value += +_alphaStrikeForceStats.damage.medium;
  if (
    _alphaStrikeForceStats.damage.long.toString() !== "0*" &&
    _alphaStrikeForceStats.damage.long.toString() !== "-"
  )
  ...
  if (
    ...
    _calcLogAS +=
      "Unit Size Factor: " +
      _alphaStrikeForceStats.sizeClass / 2 +
      " ( " +
      _alphaStrikeForceStats.sizeClass +
      " / 2)<br />\n";
  }
  ...
  if (_alphaStrikeForceStats.move > _alphaStrikeForceStats.jumpMove) {
    movementDefenseValue += _alphaStrikeForceStats.move * 0.25;
    bestMovement = _alphaStrikeForceStats.move;
  } else {
    movementDefenseValue += _alphaStrikeForceStats.jumpMove * 0.25;
    bestMovement = _alphaStrikeForceStats.move;
  }
  ...
  if (+rearDamage.short > 0 || +rearDamage.medium > 0 || +rearDamage.long > 0) {
  ...
  for (let aC = 0; aC < _alphaStrikeForceStats.abilityCodes.length; aC++) {
    ...
    if (_alphaStrikeForceStats.abilityCodes[aC].toLowerCase() === "heat") {
      ...
      _alphaStrikeForceStats.abilityCodes[aC] =
        "Heat " +
        heatDamage.short +
        "/" +
        heatDamage.medium +
      ...
      _calcLogAS +=
        "<strong>Adding</strong> Heat Ability: " +
        heatDamage.short +
        "/" +
        heatDamage.medium +
        "/" +
        ...
        "<br />\n";
      _calcLogAS +=
        "Adding Heat Damage Factor to PV: " + highestDamage + "<br />\n";
      if (heatDamage.medium.toString() !== "-" && +heatDamage.medium > 0)
    ...
    if (_alphaStrikeForceStats.abilityCodes[aC].toLowerCase() === "lrm") {
      ...
      _alphaStrikeForceStats.abilityCodes[aC] =
        ...
        lrmDamage.long;
      _calcLogAS +=
        "<strong>Adding</strong> LRM Ability: " +
        lrmDamage.short +
        "/" +
        lrmDamage.medium +
        "/" +
    ...
    if (_alphaStrikeForceStats.abilityCodes[aC].toLowerCase() === "flak") {
      ...
      _alphaStrikeForceStats.abilityCodes[aC] =
        ...
        flakDamage.long;
      _calcLogAS +=
        "<strong>Adding</strong> Flak Ability: " +
        flakDamage.short +
        "/" +
        flakDamage.medium +
        "/" +
    ...
    if (_alphaStrikeForceStats.abilityCodes[aC].toLowerCase() === "ac") {
      ...
      _alphaStrikeForceStats.abilityCodes[aC] =
        "AC " + acDamage.short + "/" + acDamage.medium + "/" + acDamage.long;
      _calcLogAS +=
        "<strong>Adding</strong> AC Ability: " +
        acDamage.short +
        "/" +
        acDamage.medium +
        "/" +
    ...
    if (_alphaStrikeForceStats.abilityCodes[aC].toLowerCase() === "srm") {
      ...
      _alphaStrikeForceStats.abilityCodes[aC] =
        ...
        srmDamage.long;
      _calcLogAS +=
        "<strong>Adding</strong> SRM Ability: " +
        srmDamage.short +
        "/" +
        srmDamage.medium +
        "/" +
    ...
    if (
      _alphaStrikeForceStats.abilityCodes[aC].toLowerCase() === "missile" ||
      _alphaStrikeForceStats.abilityCodes[aC].toLowerCase() === "msl"
    ) {
      ...
      _alphaStrikeForceStats.abilityCodes[aC] =
        ...
        mslDamage.long;
      _calcLogAS +=
        "<strong>Adding</strong> Missile Ability: " +
        mslDamage.short +
        "/" +
        mslDamage.medium +
        "/" +
    ...
    if (_alphaStrikeForceStats.abilityCodes[aC].toLowerCase() === "rear") {
      ...
      _alphaStrikeForceStats.abilityCodes[aC] =
        ...
        rearDamage.long;
      _calcLogAS +=
        "<strong>Adding</strong> Rear Ability: " +
        rearDamage.short +
        "/" +
        rearDamage.medium +
        "/" +
    ...
    if (
      _alphaStrikeForceStats.abilityCodes[aC].toLowerCase() ===
        "indirect fire" ||
      ...
      _calcLogAS +=
        "<strong>Adding</strong> IF Ability: " +
        indirectFireRating +
        "<br />\n";
      offensive_value += indirectFireRating;
      _calcLogAS +=
        "Adding IF Rating to PV: " + indirectFireRating + "<br />\n";
    }
  }
  ...
  if (_alphaStrikeForceStats.type.toLowerCase().trim() === "bm") {
    _calcLogAS +=
      "Armor Factor: " +
      _alphaStrikeForceStats.armor * 2 +
      " ( " +
      _alphaStrikeForceStats.armor +
      " * 2)<br />\n";
  ...
  if (_alphaStrikeForceStats.type.toLowerCase().trim() === "bm") {
    _calcLogAS +=
      ...
      " ( " +
      _alphaStrikeForceStats.structure +
      " * 1)<br />\n";
...
export function adjustAlphaStrikeDamage(
  ...
  if (incomingDamageObjects.short.toString() === "0") {
    if (useZeros) incomingDamageObjects.short = 0;
    else incomingDamageObjects.short = 0;
  } else if (+incomingDamageObjects.short < 0.5) {
  ...
  if (incomingDamageObjects.medium.toString() === "0") {
    if (useZeros) incomingDamageObjects.medium = 0;
    else incomingDamageObjects.medium = 0;
  } else if (+incomingDamageObjects.medium < 0.5) {
  ...
  if (incomingDamageObjects.long.toString() === "0") {
    if (useZeros) incomingDamageObjects.long = 0;
    else incomingDamageObjects.long = 0;
  } else if (+incomingDamageObjects.long < 0.5) {
  ...
  if (incomingDamageObjects.extreme.toString() === "0") {
    if (useZeros) incomingDamageObjects.extreme = 0;
    else incomingDamageObjects.extreme = 0;
  } else if (+incomingDamageObjects.extreme < 0.5) {
