...
export const CONST_AS_SPECIAL_ABILITIES: IASSpecialAbility[] = [
    ...
    ***************************** */
  {
    ...
    summary: [
      "IndustrialMechs and support vehicles equipped with Advanced Fire Control do not suffer Target Number modifiers for their unit type.",
    ],
    asce_page: 76,
  ...
  },
  {
    ...
    name: "Angel ECM",
    summary: [
      "An Angel ECM suite has the effects of standard ECM (see p. 77), but is treated as two standard ECM suites if using the ECM/ECCM optional rule (see p. 161).",
    ],
    asce_page: 76,
    type: ESpecialAbilityType.Standard,
  },
  {
    ...
    name: "Anti-'Mech",
    summary: [
      "Infantry units with the Anti-’Mech (AM) special ability can make a special attack against any ground units, landed VTOLs and WiGEs, or grounded aerospace units with which they are in base-to-base contact. Anti-’Mech Infantry attacks are treated as a physical attack (see p. 45).",
    ],
    asce_page: 76,
    type: ESpecialAbilityType.Standard,
  },
  ...
  },
  {
    ...
    summary: [
      "A unit with this special ability applies a -1 modifier on the Determining Motive Systems Damage roll (see Motive Systems Damage Table, p. 50).",
    ],
    asce_page: 76,
    type: ESpecialAbilityType.Standard,
  },
  {
    ...
    summary: [
      "The BAR special indicates a unit that is protected by substandard armor (or commercial-grade armor). Successful attacks against such units always trigger a roll for critical hits, regardless of whether or not the structure is damaged.",
    ],
    asce_page: 77,
    type: ESpecialAbilityType.Standard,
  },
  {
    ...
    summary: [
      "A support vehicle or IndustrialMech with this ability has an inferior targeting and tracking system, which adds a Target Number modifier of +1 for its attack. (This modifier is listed in the Attack Modifiers Table, see p. 44.)",
    ],
    asce_page: 77,
    type: ESpecialAbilityType.Standard,
  },
  {
    ...
    summary: [
      "A ’Mech protected by HarJel ignores the additional “hull breach” critical hit checks required for being attacked while underwater or in a vacuum. All other causes for critical hit rolls still apply as normal.",
    ],
    asce_page: 77,
    type: ESpecialAbilityType.Standard,
  },
  ...
  },
  {
    tag: "RAIL",
    name: "Rail",
    summary: ["A unit with the Rail special can only move along rails."],
    asce_page: 88,
    type: ESpecialAbilityType.Optional,
  },
  {
