...
export default class MechCreatorSideMenu extends React.Component<
  IMechCreatorSideMenuProps,
  IMechCreatorSideMenuState
> {
  render = (): JSX.Element => {
    return (
      <>
          ...
          <li>
            ...
            >
              ...
              <div className="subtitle">
                Add weapons, ammunition and other equipment
              </div>
            </Link>
          </li>
          <li>
