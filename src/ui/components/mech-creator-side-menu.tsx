      ...
      return (
          <>
            <ul className="sidebar-menu">
                <li>
                    <Link
                        to={`${import.meta.env.BASE_URL}/classic-battletech/mech-creator`}
                ...
                <li>
                    <Link
                        to={`${import.meta.env.BASE_URL}/classic-battletech/mech-creator/step2`}
                ...
                <li>
                    <Link
                        to={`${import.meta.env.BASE_URL}/classic-battletech/mech-creator/step3`}
                ...
                <li>
                    <Link
                        to={`${import.meta.env.BASE_URL}/classic-battletech/mech-creator/step4`}
                ...
                <li>
                    <Link
                        to={`${import.meta.env.BASE_URL}/classic-battletech/mech-creator/step5`}
                ...
                <li>
                    <Link
                        to={`${import.meta.env.BASE_URL}/classic-battletech/mech-creator/step6`}
                ...
                <li>
                    <Link
                        to={`${import.meta.env.BASE_URL}/classic-battletech/mech-creator/summary`}
                ...
                <li>
                    <Link
                        to={`${import.meta.env.BASE_URL}/classic-battletech/mech-creator/exports`}
                ...
                <li>
                    <Link
                        to={`${import.meta.env.BASE_URL}/classic-battletech/mech-creator/imports`}
