...
export default class HeatSinksSVG extends React.Component<
  IHeatSinksSVGProps,
  IHeatSinksSVGState
> {
  ...
  render = (): JSX.Element => {
    ...
    return (
      ...
      >
        <text
          x={this.props.xLoc + 205 / 2}
          y={this.props.yLoc + 75 + lineHeight * 0}
          textAnchor="middle"
        ...
        <text
          x={this.props.xLoc + 205 / 2}
          y={this.props.yLoc + 75 + lineHeight * 2}
          textAnchor="middle"
          fontFamily="sans-serif"
          fill={strokeColor}
          style={{ fontWeight: 700 }}
        ...
        >
          {this.props.mechData.getHeatSinks()}
        </text>
        \n";
        <text
          x={this.props.xLoc + 205 / 2}
          y={this.props.yLoc + 75 + lineHeight * 3}
          textAnchor="middle"
          fontFamily="sans-serif"
          fill={strokeColor}
          ...
          fontSize={lineHeight - 6}
        >
          {this.props.mechData.getHeatSinksObj().name}
        </text>
        \n";
        {heatSinkDots}
      </RecordSheetGroupBoxSVG>
