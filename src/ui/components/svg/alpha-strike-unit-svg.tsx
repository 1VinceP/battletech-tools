...
export default class AlphaStrikeUnitSVG extends React.Component<
  IAlphaStrikeUnitSVGProps,
  IAlphaStrikeUnitSVGState
> {
  height: string = "100%";
  width: string = "auto";
  damageLeftBase = 0;
  ...
  private _takeDamage = (damageTaken: number): void => {
    if (this.props.inPlay && this.props.asUnit) {
      ...
      this.props.appGlobals.saveCurrentASForce(
    ...
    if (this.props.inPlay && this.props.asUnit) {
      if (target === "armor") {
        if (this.props.asUnit.currentArmor.length > indexNumber) {
          this.props.asUnit.currentArmor[indexNumber] =
            !this.props.asUnit.currentArmor[indexNumber];
          this.props.asUnit.calcCurrentValues();
          this.props.appGlobals.saveCurrentASForce(
            this.props.appGlobals.currentASForce,
        ...
        if (this.props.asUnit.currentStructure.length > indexNumber) {
          this.props.asUnit.currentStructure[indexNumber] =
            !this.props.asUnit.currentStructure[indexNumber];
          this.props.asUnit.calcCurrentValues();
          this.props.appGlobals.saveCurrentASForce(
            this.props.appGlobals.currentASForce,
  ...
  private _toggleEngineHit = (indexNumber: number) => {
    if (this.props.inPlay && this.props.asUnit) {
      if (this.props.asUnit.engineHits.length > indexNumber) {
        this.props.asUnit.engineHits[indexNumber] =
          !this.props.asUnit.engineHits[indexNumber];
        this.props.asUnit.calcCurrentValues();
        this.props.appGlobals.saveCurrentASForce(
          this.props.appGlobals.currentASForce,
  ...
  private _toggleWeaponHit = (indexNumber: number): void => {
    if (this.props.inPlay && this.props.asUnit) {
      if (this.props.asUnit.weaponHits.length > indexNumber) {
        this.props.asUnit.weaponHits[indexNumber] =
          !this.props.asUnit.weaponHits[indexNumber];
        this.props.asUnit.calcCurrentValues();
        this.props.appGlobals.saveCurrentASForce(
          this.props.appGlobals.currentASForce,
  ...
  private _toggleVehicle910 = (indexNumber: number): void => {
    if (this.props.inPlay && this.props.asUnit) {
      if (this.props.asUnit.vehicleMotive910.length > indexNumber) {
        this.props.asUnit.vehicleMotive910[indexNumber] =
          !this.props.asUnit.vehicleMotive910[indexNumber];
        this.props.asUnit.calcCurrentValues();
        this.props.appGlobals.saveCurrentASForce(
          this.props.appGlobals.currentASForce,
  ...
  private _toggleVehicle11 = (indexNumber: number): void => {
    if (this.props.inPlay && this.props.asUnit) {
      if (this.props.asUnit.vehicleMotive11.length > indexNumber) {
        this.props.asUnit.vehicleMotive11[indexNumber] =
          !this.props.asUnit.vehicleMotive11[indexNumber];
        this.props.asUnit.calcCurrentValues();
        this.props.appGlobals.saveCurrentASForce(
          this.props.appGlobals.currentASForce,
  ...
  private _toggleFireControlHit = (indexNumber: number): void => {
    if (this.props.inPlay && this.props.asUnit) {
      if (this.props.asUnit.fireControlHits.length > indexNumber) {
        this.props.asUnit.fireControlHits[indexNumber] =
          !this.props.asUnit.fireControlHits[indexNumber];
        this.props.asUnit.calcCurrentValues();
        this.props.appGlobals.saveCurrentASForce(
          this.props.appGlobals.currentASForce,
  ...
  private _toggleMPHit = (indexNumber: number): void => {
    if (this.props.inPlay && this.props.asUnit) {
      if (this.props.asUnit.mpControlHits.length > indexNumber) {
        this.props.asUnit.mpControlHits[indexNumber] =
          !this.props.asUnit.mpControlHits[indexNumber];
        this.props.asUnit.calcCurrentValues();
        this.props.appGlobals.saveCurrentASForce(
          this.props.appGlobals.currentASForce,
      ...
      dots.push(
        <React.Fragment key={currentCount}>
          <circle
            ...
            cx={
              this.damageLeftBase + xLoc + currentLeftCount * (radius * 2 + 9)
            }
            cy={yLoc}
            r={radius + 3}
            fill={strokeColor}
          ...
          {target === "armor" ? (
            <circle
              ...
              fill={
                this.props.inPlay &&
                this.props.asUnit &&
                this.props.asUnit.currentArmor.length > currentCount &&
                this.props.asUnit.currentArmor[currentCount]
                  ? this.activeDotColor
                  : fillColor
              }
              onClick={() => this._toggleArmorOrStructure(target, currentCount)}
            ...
            <circle
              ...
              fill={
                this.props.inPlay &&
                this.props.asUnit &&
                this.props.asUnit.currentStructure.length > currentCount &&
                this.props.asUnit.currentStructure[currentCount]
                  ? this.activeDotColor
                  : fillColor
              }
              onClick={() => this._toggleArmorOrStructure(target, currentCount)}
  ...
  render = (): JSX.Element => {
    ...
    let abilitiesSplit: string[][] = this._splitAbilities(
      this.props.asUnit.abilities.join(", "),
    );
          ...
          <g transform="translate(0, 0)">
            ...
            {this.props.asUnit.imageURL ? (
              <image
                x="440"
                y="10"
                href={this.props.asUnit.imageURL}
                width="550"
                height="500"
              ></image>
            ) : (
            ...
            {this.props.asUnit.customName ? (
              <>
                <text x="20" y="50" fontFamily="sans-serif" fontSize="40">
                  {this.props.asUnit.customName}
                </text>
                <text x="20" y="75" fontFamily="sans-serif" fontSize="25">
                  {this.props.asUnit.name.toUpperCase()}
                </text>
              </>
            ) : (
              <text x="20" y="50" fontFamily="sans-serif" fontSize="40">
            ...
            {pilotAbilitiesList.length > 0 ? (
              <text
                ...
                className={
                  this.props.inPlay &&
                  this.props.asUnit &&
                  this.props.showSpecialAbility
                    ? "cursor-pointer"
                    : ""
                }
                onClick={(e) =>
                  this._showPilotAbility(
                    e,
                    this.props.asUnit
            ...
            <text
              ...
              fontSize="33"
            >
              PV: {this.props.asUnit.currentPoints}
            </text>
            {this.props.asUnit.currentPoints !==
            this.props.asUnit.basePoints ? (
              <text
                x="988"
                y="60"
                textAnchor="end"
                ...
                fontSize="20"
              >
                Base PV: {this.props.asUnit.basePoints.toString().toUpperCase()}
              </text>
            ) : null}
            {this.props.asUnit.currentPilotAbility ? (
              <text
              ...
              >
                Pilot PV:{" "}
                {this.props.asUnit.currentPilotAbility.cost
                  .toString()
                  .toUpperCase()}
              </text>
            ) : null}
            ...
            <rect
              ...
              ry="15"
            ></rect>
            <text x="30" y="140" fontFamily="sans-serif" fontSize="25">
              TP: {this.props.asUnit.type}
            </text>
            <text x="150" y="140" fontFamily="sans-serif" fontSize="25">
              SZ: {this.props.asUnit.size}
            </text>
            {!this.props.asUnit.isAerospace ? (
              <text x="235" y="140" fontFamily="sans-serif" fontSize="25">
                TMM: {this.props.asUnit.currentTMM.toUpperCase()}
              </text>
            ) : (
              <></>
            )}
            ...
            {this.props.measurementsInHexes ? (
              <text
                ...
                fontSize="25"
              >
                MV: {this.props.asUnit.currentMoveHexes.trim()}
              </text>
            ) : (
              <text
                x="540"
                ...
                fontSize="25"
              >
                MV: {this.props.asUnit.currentMove.trim()}
              </text>
            )}
              ...
              <>
                {this.props.measurementsInHexes ? (
                  <text
                    ...
                    fontSize="15"
                  >
                    Sprint: {this.props.asUnit.currentMoveHexesSprint.trim()}
                  </text>
                ) : (
                  <text
                    x="540"
                    ...
                    fontSize="15"
                  >
                    Sprint: {this.props.asUnit.currentMoveSprint.trim()}
                  </text>
                )}
              </>
            ) : null}

            <text x="30" y="180" fontFamily="sans-serif" fontSize="25">
              ROLE: {this.props.asUnit.role.toUpperCase()}
            </text>
            <text
              x="540"
              y="180"
              ...
              fontSize="25"
            >
              SKILL: {this.props.asUnit.currentSkill}
            </text>
            <rect
              x="20"
              y="210"
            ...
            <text
              ...
              textAnchor="middle"
              fontSize="15"
              transform="rotate(270, 58, 250)"
            >
              DAMAGE
            </text>
            {this.props.forPrint ? (
              <text
                x={damageLabelColWidth + damageColWidth * 0}
                y="245"
                fontFamily="sans-serif"
                textAnchor="middle"
                fontSize="20"
              ...
              <text
                ...
                fontSize="20"
              >
                S (0 | {this.props.asUnit.currentToHitShort}+)
              </text>
            )}
            {this.props.measurementsInHexes ? (
              <text
            ...
            <text
              ...
              fontSize={35}
            >
              {this.props.asUnit.currentDamage.short}
              {this.props.asUnit.currentDamage.shortMinimal ? "*" : ""}
            </text>
            {this.props.forPrint ? (
              <text
                x={damageLabelColWidth + damageColWidth * 1}
                y="245"
                fontFamily="sans-serif"
                textAnchor="middle"
                fontSize="20"
              ...
              <text
                ...
                fontSize="20"
              >
                M (+2 | {this.props.asUnit.currentToHitMedium}+)
              </text>
            )}
            {this.props.measurementsInHexes ? (
              <text
            ...
            <text
              ...
              fontSize={35}
            >
              {this.props.asUnit.currentDamage.medium}
              {this.props.asUnit.currentDamage.mediumMinimal ? "*" : ""}
            </text>
            {this.props.forPrint ? (
              <text
                x={damageLabelColWidth + damageColWidth * 2}
                y="245"
                fontFamily="sans-serif"
                textAnchor="middle"
                fontSize="20"
              ...
              <text
                ...
                fontSize="20"
              >
                L (+4 | {this.props.asUnit.currentToHitLong}+)
              </text>
            )}
            ...
            <text
              ...
              fontSize={35}
            >
              {this.props.asUnit.currentDamage.long}
              {this.props.asUnit.currentDamage.longMinimal ? "*" : ""}
            </text>
            {this.props.showExtreme && this.props.asUnit.damage.extreme > 0 ? (
              this.props.forPrint ? (
                <text
                  x={damageLabelColWidth + damageColWidth * 3}
                  y="245"
                  fontFamily="sans-serif"
                  textAnchor="middle"
                  fontSize="20"
                ...
                <text
                  ...
                  fontSize="20"
                >
                  E (+6 | {this.props.asUnit.currentToHitExtreme}+)
                </text>
              )
            ) : null}
            {this.props.showExtreme && this.props.asUnit.damage.extreme > 0 ? (
              <text
                ...
                fontSize={35}
              >
                {this.props.asUnit.currentDamage.extreme}
                {this.props.asUnit.currentDamage.extremeMinimal ? "*" : ""}
              </text>
            ) : null}
            {this.props.showExtreme && this.props.asUnit.damage.extreme > 0 ? (
              <>
            ...
            <rect
              ...
              ry="15"
            ></rect>
            <text x="40" y="365" fontFamily="sans-serif" fontSize={35}>
              OV: {this.props.asUnit.overheat}
            </text>
            <text
              x="240"
              y="363"
            ...
            <rect
              ...
              className={
                this.props.inPlay && this.props.asUnit ? "cursor-pointer" : ""
              }
              x="325"
              y="330"
              width="25"
              ...
              fill={
                this.props.inPlay &&
                this.props.asUnit &&
                this.props.asUnit.currentHeat === 0
                  ? "rgb(0,200,0)"
                  : "rgb(102,102,102)"
              }
            ></rect>
            ...
            <rect
              ...
              fill={
                this.props.inPlay &&
                this.props.asUnit &&
                this.props.asUnit.currentHeat === 1
                  ? "rgb(204, 187, 0)"
                  : "rgb(102,102,102)"
              }
            ></rect>
            ...
            <rect
              ...
              fill={
                this.props.inPlay &&
                this.props.asUnit &&
                this.props.asUnit.currentHeat === 2
                  ? "rgb(236,87,16)"
                  : "rgb(102,102,102)"
              }
            ></rect>
            ...
            <rect
              ...
              fill={
                this.props.inPlay &&
                this.props.asUnit &&
                this.props.asUnit.currentHeat === 3
                  ? "rgb(200,0,0)"
                  : "rgb(102,102,102)"
              }
            ></rect>
            ...
            {this.props.inPlay ? (
              <>
                <rect
                  onClick={this._toggleTakeDamage}
            ...
            {this.state.showTakeDamage ? (
              <>
                <text
                  ...
                  fontSize="15"
                >
                  Click below to add damage taken
                </text>
                <rect
                  x="80"
                  y="435"
                    ...
                    <React.Fragment key={lineIndex}>
                      {line.map((word, wordIndex) => {
                        ...
                        if (this.props.asUnit && this.props.inPlay) {
                          let ability =
                            this.props.asUnit.getSpecialAbility(word);
                          if (ability !== null) {
                            return (
                              <React.Fragment key={wordIndex}>
                                <a
                                  onClick={(e) =>
                                    //@ts-ignore
                                    this.props.showSpecialAbility(e, ability)
                                  }
                                  title={
                                    "Click here to view the description for " +
                                    word
                                  }
                                  href="/"
                                >
              ...
              <>
                ...
                {this.props.asUnit.type.toLowerCase() !== "pm" ? (
                  <>
                      ...
                      return (
                        <React.Fragment key={ehIndex}>
                          <circle
                            ...
                            fill="rgb(0,0,0)"
                            className={
                              this.props.inPlay ? "cursor-pointer" : ""
                            }
                    ...
                    <text
                      x="750"
                      y={critLineStart + this.buttonRadius + 3}
                      textAnchor="start"
                      fontFamily="sans-serif"
                      fontSize="12"
                    >
                ...
                {this.props.asUnit.type.toLowerCase() === "bm" ||
                this.props.asUnit.type.toLowerCase() === "pm" ? (
                  <>
                    <text
                      x="750"
                ...
                {this.props.asUnit.type.toLowerCase() === "cv" ||
                this.props.asUnit.type.toLowerCase() === "sv" ? (
                  <>
                    <text
                      x="750"
                      y={critLineStart}
                    ...
                    <circle
                      ...
                      className=""
                      cx="770"
                      cy={critLineStart + this.buttonRadius - 27 + 3}
                      r={this.buttonRadius}
                      fill="rgb(0,0,0)"
                    ></circle>
                    <circle
                      ...
                      r={this.buttonRadius - 3}
                      fill={
                        this.props.asUnit.vehicleMotive910[0]
                          ? this.activeDotColor
                          : "rgb(255,255,255)"
                      }
                    ></circle>
                    ...
                    <circle
                      ...
                      r={this.buttonRadius - 3}
                      fill={
                        this.props.asUnit.vehicleMotive910[1]
                          ? this.activeDotColor
                          : "rgb(255,255,255)"
                      }
                    ></circle>
                    ...
                    <circle
                      ...
                      r={this.buttonRadius - 3}
                      fill={
                        this.props.asUnit.vehicleMotive11[0]
                          ? this.activeDotColor
                          : "rgb(255,255,255)"
                      }
                    ></circle>
                    ...
                    <circle
                      ...
                      r={this.buttonRadius - 3}
                      fill={
                        this.props.asUnit.vehicleMotive11[1]
                          ? this.activeDotColor
                          : "rgb(255,255,255)"
                      }
                    ></circle>
                    ...
                    <circle
                      ...
                      r={this.buttonRadius - 3}
                      fill={
                        this.props.asUnit.vehicleMotive12
                          ? this.activeDotColor
                          : "rgb(255,255,255)"
                      }
                    ></circle>
            ...
            <BattleTechLogo xLoc={750} yLoc={600} width={250} />
          </g>
        </svg>
      </>
    );
