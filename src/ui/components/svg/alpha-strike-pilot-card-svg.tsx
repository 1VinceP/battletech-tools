...
export default class AlphaStrikePilotCardSVG extends React.Component<
  IAlphaStrikePilotCardSVGProps,
  IAlphaStrikePilotCardSVGState
> {
  height: string = "100%";
  width: string = "auto";
  damageLeftBase = 0;
        ...
        >
          <g transform="translate(0, 0)">
            ...
            <text
              ...
              fontSize="33"
            >
              PV: {this.props.pilotAbility.cost}
            </text>

            <text x="20" y="60" fontFamily="sans-serif" fontSize="60">
