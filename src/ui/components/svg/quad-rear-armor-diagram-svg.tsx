...
export default class QuadRearArmorDiagramSVG extends React.Component<
  IQuadRearArmorDiagramSVGProps,
  IQuadRearArmorDiagramSVGState
> {
  ...
  render = (): JSX.Element => {
    ...
    return (
      ...
      >
        <g>
          <g id="layer1" transform="translate(0,-644.88234)">
            <path
