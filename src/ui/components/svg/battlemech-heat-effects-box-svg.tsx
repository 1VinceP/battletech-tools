...
export default class BattleMechHeatEffectsBoxSVG extends React.Component<
  IBattleMechHeatEffectsBoxSVGProps,
  IBattleMechHeatEffectsBoxSVGState
> {
  ...
  render = (): JSX.Element => {
    ...
    effectsTable.push(
      <text
        ...
        x={this.props.xLoc + col1Loc + 20}
        y={this.props.yLoc + 75 + lineHeight * hCounter}
        textAnchor="end"
