...
export default class RecordSheetEquipmentTable extends React.Component<
  IRecordSheetEquipmentTableProps,
  IRecordSheetEquipmentTableState
> {
  ...
  render = (): JSX.Element => {
    ...
    for (
      let eq_count = 0;
      eq_count < this.props.mechData.equipmentList.length;
      eq_count++
    ) {
      if (eq_count % 2 === 0)
        equipmentList.push(
          <rect
            key={eq_count.toString() + "a"}
            x={wacCol1 - 5}
            y={weapAndEqpTop + 93 + eqLineHeight * eq_count}
            width={1180}
            height={eqLineHeight + 4}
            fill={colorVeryLightGray}
          />,
        );
      ...
      let isAmmo = this.props.mechData.equipmentList[eq_count].isAmmo
        ? true
        : false;
      let isEquipment = this.props.mechData.equipmentList[eq_count].isEquipment
        ? true
        : false;
      ...
      if (this.props.inPlay && !isAmmo && !isEquipment) {
        ...
        equipmentList.push(
          <text
            key={eq_count.toString() + "b"}
            x={wacCol1 + 30}
            y={weapAndEqpTop + 120 + eqLineHeight * eq_count}
            textAnchor="middle"
            fontFamily="sans-serif"
            fill={strokeColor}
            ...
            fontSize={30}
          >
            {this.props.mechData.equipmentList[eq_count].count}
          </text>,
        );
      }
      ...
      if (ammoPerTon && isAmmo)
        equipmentList.push(
          <text
            ...
            onClick={this.openSetTargetDialog}
            key={eq_count.toString() + "c"}
            x={wacCol2}
            y={weapAndEqpTop + 120 + eqLineHeight * eq_count}
            textAnchor="start"
            fontFamily="sans-serif"
            ...
            fontSize={30}
          >
            {this.props.mechData.equipmentList[eq_count].name + rearDesignation}{" "}
            {currentAmmo}/
            {this.props.mechData.equipmentList[eq_count].ammoPerTon}{" "}
          </text>,
        );
      else
        equipmentList.push(
        ...
        if (this.props.mechData.equipmentList[eq_count].heatPerShot) {
          equipmentList.push(
            <text
              ...
              fontSize={30}
            >
              {this.props.mechData.equipmentList[eq_count].heat}/shot
            </text>,
          );
        } else {
          equipmentList.push(
            <text
              ...
              fontSize={30}
            >
              {this.props.mechData.equipmentList[eq_count].heat}
            </text>,
          );
        }
        if (this.props.mechData.equipmentList[eq_count].damagePerCluster) {
          equipmentList.push(
            <text
              ...
              fontSize={30}
            >
              {this.props.mechData.equipmentList[eq_count].damagePerCluster}/hit
            </text>,
          );
        } else {
          if (this.props.mechData.equipmentList[eq_count].damagePerShot) {
            equipmentList.push(
              <text
                ...
                fontSize={30}
              >
                {this.props.mechData.equipmentList[eq_count].damagePerShot}/shot
              </text>,
            );
          } else {
            if (
              typeof this.props.mechData.equipmentList[eq_count].damage !==
              "undefined"
            ) {
              if (
                typeof this.props.mechData.equipmentList[eq_count].damage ===
                ...
                equipmentList.push(
                  ...
                  >
                    {/* @ts-ignore */}
                    {this.props.mechData.equipmentList[eq_count].damage}
                  </text>,
                );
              } else {
                equipmentList.push(
                  ...
                  className={this.props.inPlay ? "cursor-pointer" : ""}
                    ...
                    >
                    {/* @ts-ignore */}
                    {this.props.mechData.equipmentList[eq_count].damage.short} /{" "}
                    {/* @ts-ignore */}
                    {this.props.mechData.equipmentList[eq_count].damage.medium}{" "}
                    {/* @ts-ignore */}
                    / {this.props.mechData.equipmentList[eq_count].damage.long}
                  </text>,
                );
              }
            }
          ...
          if (this.props.mechData.equipmentList[eq_count].range.min === 0)
            ...
            equipmentList.push(
              <text
                ...
                fontSize={30}
              >
                {this.props.mechData.equipmentList[eq_count].range.min}
              </text>,
            );
          equipmentList.push(
            <text
              ...
              fontSize={30}
            >
              {this.props.mechData.equipmentList[eq_count].range.short}
            </text>,
          );
          equipmentList.push(
            <text
              ...
              fontSize={30}
            >
              {this.props.mechData.equipmentList[eq_count].range.medium}
            </text>,
          );
          equipmentList.push(
            <text
              ...
              fontSize={30}
            >
              {this.props.mechData.equipmentList[eq_count].range.long}
            </text>,
          );
        }
      }
