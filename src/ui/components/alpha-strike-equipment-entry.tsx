...
export default class AlphaStrikeEquipmentEntry extends React.Component<
  IAlphaStrikeEquipmentEntryProps,
  IAlphaStrikeEquipmentEntryState
> {
  ...
  updateTC = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateShort = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateMedium = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateLong = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateExtreme = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateNotes = (e: React.FormEvent<HTMLTextAreaElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
