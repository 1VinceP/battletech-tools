...
export default class DamageInput extends React.Component<
  IDamageInputProps,
  IDamageInputState
> {
  showDialog: boolean = false;

  toggleDamageDivisor = (e: React.FormEvent<HTMLInputElement>) => {
  ...
  toggleDamageIsInClusters = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
    ...
    if (
      (!this.props.editingItem.damageClusters ||
        this.props.editingItem.damageClusters === 0) &&
      (!this.props.editingItem.damagePerCluster ||
  ...
  toggleDamagePerRange = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateDamageDivisor = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateDamageAerospace = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateDamagePerCluster = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateDamageClusters = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateDamage = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateDamagePerShot = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateDamageShort = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateDamageMedium = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateDamageLong = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateDamageAeroShort = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateDamageAeroMedium = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateDamageAeroLong = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
      ...
      <fieldset className="fieldset">
        ...
        <InputCheckbox
          ...
          checked={
            ...
            this.props.editingItem.damageDivisor > 0
              ? true
              : false
          }
        />
