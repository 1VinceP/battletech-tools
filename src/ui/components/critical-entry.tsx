...
export default class CriticalEntry extends React.Component<
  ICriticalEntryProps,
  ICriticalEntryState
> {
  ...
  updateBattlemech = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
  ...
  updateProtomech = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let value = this.props.valueCritical;
  ...
  updateSupportVehicle = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let value = this.props.valueCritical;
  ...
  updateCombatVehicle = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let value = this.props.valueCritical;
  ...
  updateAerospaceFighter = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let value = this.props.valueCritical;
  ...
  updateSmallCraft = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let value = this.props.valueCritical;
  ...
  updateDropShip = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let value = this.props.valueCritical;
    ...
    return (
      <fieldset className="fieldset">
        ...
        <InputCheckbox
          ...
          checked={
            this.props.valueCriticalDivisor &&
            this.props.valueCriticalDivisor > -1
              ? true
              : false
          }
        />
        {this.props.valueCriticalDivisor && this.props.valueCriticalDivisor ? (
          ...
          <>
            <div className="small-font">
              If equipment is not available on a vehicle, place a -1 in the
              critical slots for that type.
            </div>
            <InputNumeric
              label="Battlemech"
