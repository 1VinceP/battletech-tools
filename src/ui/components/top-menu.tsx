          ...
          <ul className="main-menu">
                  ...
                  item.subMenu.length > 0 ? (
                    <>
                      <li className="d-none d-md-inline">
                        <Link
                          className={
                            this.props.current?.startsWith(item.startsWithTag)
                              ? "current"
                              : ""
                          }
                    ...
                    <li className="d-none d-md-inline">
                      <Link
                        className={
                          this.props.current === item.tag ? "current" : ""
                        }
                        to={`${process.env.PUBLIC_URL}${item.url}`}
                      >
                        {item.label}
            ...
            <li className="logo">
              ...
              >
                <BattleTechLogo
                  baseColor={
                    this.props.appGlobals.appSettings.uiTheme === "desaturated"
                      ? "#ddd"
                      : ""
                  }
                  altColor={
                          ...
                          return (
                            <li key={subItemIndex}>
                              <Link
                                ...
                                className={
                                  this.props.current === subItem.tag
                                    ? "current"
                                    : ""
                                }
