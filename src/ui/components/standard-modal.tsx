...
> {
  render = (): JSX.Element => {
    let labelAdd = "Add";
    if (this.props.labelAdd) labelAdd = this.props.labelAdd;
    let labelClose =
      !this.props.onSave && !this.props.onAdd ? "Close" : "Cancel";
    if (this.props.labelClose) labelClose = this.props.labelClose;
    let labelSave = "Save";
    if (this.props.labelSave) labelSave = this.props.labelSave;
    let labelSaveAsNew = "Save as New";
    if (this.props.labelSaveAsNew) labelSaveAsNew = this.props.labelSaveAsNew;
    ...
    return (
      <Modal show={this.props.show} className={this.props.className}>
        <Modal.Header>
          ...
          {this.props.topBarCheckboxFunction &&
          this.props.topBarCheckboxLabel ? (
            <InputCheckbox
        ...
        <Modal.Footer>
          <div className="text-right no-wrap full-width">
            ...
            {this.props.onClose ? (
              <>
                &nbsp;
                <button onClick={this.props.onClose} className={closeClass}>
                  {labelClose}
                </button>
              </>
            ) : null}
...
interface IStandardModalProps {
  ...
  topBarCheckboxFunction?(e: React.FormEvent<HTMLInputElement>): void;
