...
> {
  ...
  toggleIsMelee = (e: React.FormEvent<HTMLInputElement>) => {
  ...
  updateMinimum = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateAero = (e: React.FormEvent<HTMLSelectElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
      ...
      <fieldset className="fieldset">
        ...
        {!this.props.editingItem.isMelee ? (
          <>
            <InputNumeric
              value={
                this.props.editingItem.range.min
                  ? this.props.editingItem.range.min
                  : 0
              }
            ...
            <InputNumeric
              value={
                this.props.editingItem.range.extreme
                  ? this.props.editingItem.range.extreme
                  : 0
              }
            ...
            <label>
              ...
              <select
                ...
                value={
                  this.props.editingItem.rangeAero
                    ? this.props.editingItem.rangeAero
                    : ""
                }
              >
