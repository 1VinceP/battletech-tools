...
export default class AvailableEquipment extends React.Component<
  IAvailableEquipmentProps,
  IAvailableEquipmentState
> {
  ...
  render = (): JSX.Element => {
    let currentCategory =
      this.props.appGlobals.appSettings.installEquipCategory;
