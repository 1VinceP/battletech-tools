...
export default class EquipmentEditForm extends React.Component<
  IEquipmentEditFormProps,
  IEquipmentEditFormState
> {
  ...
  updateCbills = (e: React.FormEvent<HTMLInputElement>) => {
  ...
  updateBattleValue = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateBattleValueOneShot = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateBattleValuePerItemDamage = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateReintroduced = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateWeight = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateAmmoPerTon = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateNotes = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateMinAmmoTons = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateWeightDivisor = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateCriticalstDivisor = (newValue: number) => {
    let item = this.props.editingItem;
  ...
  toggleIsEquipment = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  toggleNeedsAmmo = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  toggleIsAmmo = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateHeat = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateHeatPerShot = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateIsStreak = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateBattleValueDefensive = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateExplosive = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateIsUltra = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateIsRotary = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateHeatAero = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  toggleWeightDivisor = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateExtinct = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updatePage = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateBook = (e: React.FormEvent<HTMLSelectElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateIntroduced = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateAlternativeName = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateSort = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
  ...
  updateTag = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) {
      e.preventDefault();
    }
    let item = this.props.editingItem;
      ...
      <div className="form">
        <div className="row">
          <div className="col-md-6">
            <TextSection label="Name, Sort, and Tag">
              <InputField
          ...
          <div className="col-md-6">
            <TextSection label="Tech, Active Years">
              <label>
                Technology:&nbsp;
                {this.props.techBase}
                <div className="small-text">
                  This is derived from the list you've chosen to edit or add to.
                </div>
              </label>
              <label>
                Category:&nbsp;
        ...
        <div className="row">
          <div className="col">
            <TextSection label="Equipment Details">
              <div className="row">
                <div className="col">
                  <InputNumeric
                    step={1}
                  ...
                  <InputCheckbox
                    ...
                    checked={
                      this.props.editingItem.weightDivisor &&
                      this.props.editingItem.weightDivisor > 0
                        ? true
                        : false
                    }
                  />
                  ...
                  <CriticalEntry
                    ...
                    valueCriticalDivisor={
                      this.props.editingItem.criticalsDivisor
                    }
                  />
                </div>
                <div className="col">
                  <InputCheckbox
                    ...
                    checked={
                      this.props.editingItem.isEquipment &&
                      this.props.editingItem.isEquipment
                        ? true
                        : false
                    }
                  ...
                  <InputCheckbox
                    ...
                    checked={
                      this.props.editingItem.needsAmmo &&
                      this.props.editingItem.needsAmmo
                        ? true
                        : false
                    }
                  ...
                  <InputCheckbox
                    ...
                    checked={
                      this.props.editingItem.explosive &&
                      this.props.editingItem.explosive
                        ? true
                        : false
                    }
        ...
        <div className="row">
          <div className="col">
            <TextSection label="Battle Values and C-Bills">
              <InputNumeric
                step={1}
              ...
              <InputCheckbox
                ...
                checked={
                  this.props.editingItem.battleValueDefensive ? true : false
                }
              />
              {/* <InputNumeric
                    step={1}
          ...
          <div className="col">
            <TextSection label="Alpha Strike Values">
