          ...
          (alert: IAlert, alertIndex: number) => {
            return (
              <div
                ...
                className={
                  alert.autoDismissSeconds > 0
                    ? "position-relative alert-fade alert alert-" +
                      alert.level +
                      " " +
                      alert.extraclass
                    : "position-relative alert alert-" +
                      alert.level +
                      " " +
                      alert.extraclass
                }
              ...
              >
                  ...
                  <>
                    <div className="alert-countdown">
                      <div
                        ...
                        className={
                          "alert-countdown-bar dismiss-time-" +
                    ...
                    <span
                      onClick={() => {
                        this.dismissAlert(alertIndex);
                      }}
                      className="pull-right cursor-pointer"
                      style={{ fontSize: "1.5rem" }}
                      title={
                        "Click here to dismiss this alert, but it'll auto-dismiss in " +
                        alert.autoDismissSeconds +
                        " seconds"
                      }
                    >
                ...
                {alert.link ? (
                  <div className="text-right">
                    <Link className="btn btn-primary btn-sm" to={alert.link}>
                      Go
                    </Link>
                  </div>
                ) : (
