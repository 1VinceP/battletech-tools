...
export default class ClassicBattleTechRosterPrint extends React.Component<
  IPrintProps,
  IPrintState
> {
      ...
      <>
        <header className="topmenu">
          <ul className="main-menu">
            ...
            <li>
              <span
                title="Click here open the Print Dialog"
        ...
        <div className={"summary-page"}>
          ...
          <table className="full-width">
            <tbody>
              <tr>
                ...
                <td className="text-center">
                  <strong>Tech:</strong>{" "}
                  {this.props.appGlobals.currentCBTForce.getTech()}
                </td>
                <td className="text-center">
              ...
              return (
                <div className="group" key={groupIndex}>
                  <table className="print-table">
                    <thead>
                      <tr>
                        <th colSpan={2} className="no-right-border">
                      ...
                      <tr>
                        <th>Unit Name</th>
                        <th className="min-width no-wrap">Tons</th>
                        <th className="min-width no-wrap">Tech</th>
                        <th className="min-width no-wrap">MW Piloting</th>
                        <th className="min-width no-wrap">MW Gunnery</th>
                        <th className="min-width no-wrap">Base BV2</th>
                        <th className="min-width no-wrap">Adjusted BV2</th>
                      </tr>
                    </thead>
          ...
          <div className="print-footer">
            ...
            <p>
              Printed using Jeff's BattleTech Tools at
              https://jdgwf.github.io/battletech-tools/. Huge thanks to the
              Master Unit List
            </p>
            <p>
