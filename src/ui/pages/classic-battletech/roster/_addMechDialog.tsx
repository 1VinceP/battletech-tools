...
export default class BattleMechAddMechDialog extends React.Component<
  IBattleMechAddMechDialogProps,
  IBattleMechAddMechDialogState
> {
  ...
  addViewedUnit = (e: React.FormEvent<HTMLButtonElement> | null) => {
    ...
    if (this.props.currentForce && this.state.viewingUnit) {
      ...
      newBM.newUUID();
      currentForce.members.push(newBM);
        ...
        <div className="row">
          <div className="col">
            <fieldset className="fieldset">
              ...
              {this.props.appGlobals.battleMechSaves.length === 0 ? (
                <div className="text-center">
                  You have no saved 'mechs. Currently this app does not have
                  permission to have any pre-built 'mechs loaded, but you should
                  be able to create existing or new ' mechs in the{" "}
                  <Link
            ...
            <fieldset className="fieldset">
              ...
              <p>
                Sorry, only Introductory Mechs can be trusted right now. Be sure
                to only semi-trust the units with a{" "}
                <FaCheckCircle
