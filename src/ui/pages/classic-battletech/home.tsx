...
export default class ClassicBattleTechHome extends React.Component<
  IClassicBattleTechHomeProps,
  IClassicBattleTechHomeState
> {
  ...
  render = (): JSX.Element => {
    return (
      <UIPage
        current="classic-battletech-home"
        appGlobals={this.props.appGlobals}
      >
        <TextSection label="Classic BattleTech">
