                    ...
                    <div className="col-md-12 col-lg-8">
                      ...
                      >
                          ...
                          <div className="clear-both overflow-hidden">
                            <hr />
                            <Link to={`${import.meta.env.BASE_URL}/classic-battletech/mech-creator/step6`} className="btn btn-primary pull-right btn-sm">Next Step <FaArrowCircleRight /></Link>
                            <div className="inline-block text-left">
                              <Link to={`${import.meta.env.BASE_URL}/classic-battletech/mech-creator/step4`} className="btn btn-primary btn-sm"><FaArrowCircleLeft /> Previous Step</Link>
                            </div>
                          </div>
                          </TextSection>
