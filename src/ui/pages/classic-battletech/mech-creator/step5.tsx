...
export default class MechCreatorStep5 extends React.Component<
  IHomeProps,
  IHomeState
> {
  ...
  removeEquipment = (itemUUID: string | undefined): boolean => {
    if (this.props.appGlobals.currentBattleMech) {
      this.props.appGlobals.currentBattleMech.removeEquipment(itemUUID);
      this.props.appGlobals.saveCurrentBattleMech(
        this.props.appGlobals.currentBattleMech,
      );
  ...
  setRear = (itemUUID: string | undefined, isRear: boolean): boolean => {
    if (this.props.appGlobals.currentBattleMech) {
      this.props.appGlobals.currentBattleMech.setRear(itemUUID, isRear);
      this.props.appGlobals.saveCurrentBattleMech(
        this.props.appGlobals.currentBattleMech,
      );
  ...
  setWeight = (itemUUID: string | undefined, weight: number): boolean => {
    if (this.props.appGlobals.currentBattleMech) {
      this.props.appGlobals.currentBattleMech.setweight(itemUUID, weight);
      this.props.appGlobals.saveCurrentBattleMech(
        this.props.appGlobals.currentBattleMech,
      );
            ...
            <div className="col-md-9 col-lg-10">
              <div className="row">
                <div className="col-md-12 col-lg-8">
                  <TextSection label="Step 5: Add weapons, ammunition and other equipment">
                    <button
                    ...
                    {this.props.appGlobals.currentBattleMech.getInstalledEquipment()
                      .length > 0 ? (
                      <table className="table">
                                ...
                                <tr>
                                  ...
                                  <td className="text-right">
                                    <button
                                      ...
                                      onClick={() =>
                                        this.removeEquipment(item.uuid)
                                      }
                                    >
                                      <FaTrash />
                                    </button>
                        ...
                        <tfoot>
                          <tr>
                            ...
                            >
                              Don't be surprised if you toggle Rear and the item
                              is moved to the bottom of the sorting list.
                            </th>
                          </tr>
                        </tfoot>
                      </table>
                      ...
                      <>
                        ...
                        <p className="text-center">
                          ...
                          &nbsp; to the top left to install equipment.
                        </p>
                      </>
                    )}
