                    ...
                    <div className="col-md-12">
                      ...
                      >
                        ...
                        <div className="clear-both overflow-hidden">
                          <hr />
                          <Link to={`${import.meta.env.BASE_URL}/classic-battletech/mech-creator/summary`} className="btn btn-primary pull-right btn-sm">Summary <FaArrowCircleRight /></Link>
                          <div className="inline-block text-left">
                              <Link to={`${import.meta.env.BASE_URL}/classic-battletech/mech-creator/step5`} className="btn btn-primary btn-sm"><FaArrowCircleLeft /> Previous Step</Link>
                            </div>
                        </div>
                      </TextSection>
