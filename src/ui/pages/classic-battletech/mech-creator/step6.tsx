...
export default class MechCreatorStep6 extends React.Component<
  IHomeProps,
  IHomeState
> {
  ...
  openSplitDialog = (e: React.FormEvent<HTMLButtonElement>) => {
  ...
  closeSplitDialog = (e: React.FormEvent<HTMLButtonElement>) => {
    if (e && e.preventDefault) e.preventDefault();
  ...
  saveSplitDialog = (e: React.FormEvent<HTMLButtonElement>) => {
    if (e && e.preventDefault) e.preventDefault();

    let selectionMessage =
      "Select a location to place your the first part of " +
      this.state.selectedItem?.name +
      " ( " +
      this.state.splitItemCount +
      " slots)";
  ...
  updateSplitItemCount = (e: React.FormEvent<HTMLInputElement>) => {
    if (e && e.preventDefault) e.preventDefault();
  ...
  toggleLowerArmActuator = (loc: string): void => {
    if (this.props.appGlobals.currentBattleMech) {
      ...
      this.props.appGlobals.saveCurrentBattleMech(
        this.props.appGlobals.currentBattleMech,
      );
    }
  };
  ...
  selectItemClick = (
    ...
    if (
      ...
      if (
        ...
        selectedItem.obj &&
        selectedItem.obj.space &&
        selectedItem.obj.space.battlemech >= 8 &&
        selectedLocation === "un"
      )
      ...
      if (this.state.isSplitting && this.state.selectedItem) {
        ...
        if (
          ...
          if (wasMoved) {
            ...
            if (this.state.selectedItem) {
              selectionMessage =
                this.state.selectedItem.name + " was successfully placed!";
            } else {
            ...
            if (this.state.selectedItem) {
              selectionMessage =
                "Cannot place that " + this.state.selectedItem.name + " there.";
              selectedItemName = "";
          ...
          if (
            ...
            let selectionMessage =
              "Select the location to place the second part of your" +
              this.state.selectedItem?.name +
              " ( " +
              (this.state.selectedItem.crits - this.state.splitItemCount) +
              " slots)";
            let selectionMessageType = "warning";
        ...
        if (
          ...
          this.setState({
            ...
            selectedItemName: selectedItemName,
            selectionMessage:
              "Select the location to move your " + selectedItem?.name,
            selectionMessageType: "warning",
            selectedItem: selectedItem,
        ...
        {this.state.splitItemCount > 0 && !this.state.isSplitting ? (
          ...
          >
            <InputNumeric
              ...
              min={1}
              max={
                this.state.selectedItem ? this.state.selectedItem.crits - 1 : 99
              }
            ...
            <div className="col-md-9 col-lg-10">
              <div className="row">
                <div className="col-md-12">
                  <TextSection label="Step 6: Complete the record sheet">
                    <fieldset className="fieldset">
                      <legend>Instructions</legend>
                      <p>
                        To assign equipment to your critical allocation table,
                        just click on an assignable item then click on an
                    ...
                    {this.state.selectionMessageType ? (
                      ...
                      <p className="text-center no-margin">
                        <strong>{this.state.selectionMessage}</strong>
                      </p>
                    )}
                    ...
                    <div className="row">
                          ...
                          {this.props.appGlobals.currentBattleMech
                            ...
                            <>
                              <p className="text-center">
                                Huzzah! All equipment has been allocated!
                              </p>
                            </>
                          )}
                      ...
                      <div className="col-lg-9">
                        <fieldset className="fieldset">
                          ...
                          <div className="row">
                            <div className="col-4">
                              {this.props.appGlobals.currentBattleMech.getType()
                                .tag === "quad" ? (
                                ...
                                <>
                                  ...
                                  <InputCheckbox
                                    checked={this.props.appGlobals.currentBattleMech.hasLowerArmActuator(
                                      "la",
                                    )}
                                    onChange={(
                                      event: React.FormEvent<HTMLInputElement>,
                                    ) => this.toggleLowerArmActuator("la")}
                                    label="Lower Arm Actuator"
                                  />

                                  <InputCheckbox
                                    checked={this.props.appGlobals.currentBattleMech.hasHandActuator(
                                      "la",
                                    )}
                                    onChange={(
                                      event: React.FormEvent<HTMLInputElement>,
                                    ) => this.toggleHandActuator("la")}
                                    label="Hand Actuator"
                                  />
                                </>
                              )}
                              <CriticalAllocationSection
                                ...
                                currentSelectedItemSize={
                                  this.state.selectedItemSize
                                }
                              ...
                              {this.props.appGlobals.currentBattleMech.getType()
                                ...
                                <>
                                  ...
                                  <InputCheckbox
                                    ...
                                    onChange={(
                                      event: React.FormEvent<HTMLInputElement>,
                                    ) => this.toggleLowerArmActuator("ra")}
                                    label="Lower Arm Actuator"
                                  />
                    ...
                    <div className="clear-both overflow-hidden">
                      ...
                      <div className="inline-block text-left">
                        ...
                        >
                          <FaArrowCircleLeft /> Previous Step
                        </Link>
                      </div>
                    </div>
                  </TextSection>
