...
export default class MechCreatorStep1 extends React.Component<
  IHomeProps,
  IHomeState
> {
  ...
  updateHideNonAvailableEquipment = (
                ...
                <div className="col-md-12 col-lg-8">
                  <TextSection label="Step 1: Design the Chassis">
                    ...
                    <label>
                      ...
                      <select
                        value={
                          this.props.appGlobals.currentBattleMech.getEra().tag
                        }
                    ...
                    <label>
                      ...
                      >
                        {btMechTonnages.map((option) => {
                          return (
                            <option key={option.tons} value={option.tons}>
                              {option.tons} ({option.type})
                            </option>
                          );
                        })}
                      </select>
