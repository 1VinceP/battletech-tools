...
export default class MechCreatorStep4 extends React.Component<
  IHomeProps,
  IHomeState
> {
  ...
  render = (): JSX.Element => {
    ...
    let weightDropDownMax =
      this.props.appGlobals.currentBattleMech.getMaxArmorTonnage();
    if (
      weightDropDownMax <
      this.props.appGlobals.currentBattleMech.getArmorWeight()
    ) {
      weightDropDownMax =
        this.props.appGlobals.currentBattleMech.getArmorWeight();
    }
                      ...
                      <div className="col-xs-12 col-md-6">
                        <label>
                          ...
                          >
                            ...
                            {makeRange(1, weightDropDownMax, 0.5).map(
                              (option) => {
                                return (
                      ...
                      "biped" ? (
                        <>
                          <div className="armor-location-select">
                            <label className="armor-select-dropdown hd">
                              ...
                              <select
                                value={
                                  this.props.appGlobals.currentBattleMech.getArmorAllocation()
                                    .head
                                }
                                onChange={(
                                  event: React.FormEvent<HTMLSelectElement>,
                                ) =>
                                  this.setArmorLocationValue(
                                    "hd",
                              ...
                              >
                                {makeRange(0, 9).map((armorValue) => {
                                  return (
                                    <option key={armorValue} value={armorValue}>
                                      {armorValue}
                                    </option>
                                  );
                                })}
                            ...
                            <label className="armor-select-dropdown ct">
                              ...
                              >
                                {makeRange(
                                  0,
                                  this.props.appGlobals.currentBattleMech.getMaxCenterTorsoArmor(),
                                ).map((armorValue) => {
                                  return (
                                    <option key={armorValue} value={armorValue}>
                                      {armorValue}
                            ...
                            <label className="armor-select-dropdown lt">
                              ...
                              >
                                {makeRange(
                                  0,
                                  this.props.appGlobals.currentBattleMech.getMaxLeftTorsoArmor(),
                                ).map((armorValue) => {
                                  return (
                                    <option key={armorValue} value={armorValue}>
                                      {armorValue}
                            ...
                            <label className="armor-select-dropdown rt">
                              ...
                              >
                                {makeRange(
                                  0,
                                  this.props.appGlobals.currentBattleMech.getMaxRightTorsoArmor(),
                                ).map((armorValue) => {
                                  return (
                                    <option key={armorValue} value={armorValue}>
                                      {armorValue}
                            ...
                            <label className="armor-select-dropdown ctr">
                              ...
                              >
                                {makeRange(
                                  0,
                                  this.props.appGlobals.currentBattleMech.getMaxCenterTorsoRearArmor(),
                                ).map((armorValue) => {
                                  return (
                                    <option key={armorValue} value={armorValue}>
                                      {armorValue}
                            ...
                            <label className="armor-select-dropdown ltr">
                              ...
                              >
                                {makeRange(
                                  0,
                                  this.props.appGlobals.currentBattleMech.getMaxLeftTorsoRearArmor(),
                                ).map((armorValue) => {
                                  return (
                                    <option key={armorValue} value={armorValue}>
                                      {armorValue}
                            ...
                            <label className="armor-select-dropdown rtr">
                              ...
                              >
                                {makeRange(
                                  0,
                                  this.props.appGlobals.currentBattleMech.getMaxRightTorsoRearArmor(),
                                ).map((armorValue) => {
                                  return (
                                    <option key={armorValue} value={armorValue}>
                                      {armorValue}
                            ...
                            <label className="armor-select-dropdown la">
                              ...
                              >
                                {makeRange(
                                  0,
                                  this.props.appGlobals.currentBattleMech.getInteralStructure()
                                    .leftArm * 2,
                                ).map((armorValue) => {
                                  return (
                                    <option key={armorValue} value={armorValue}>
                            ...
                            <BipedArmorDiagramSVG strokeColor="rgb(100,100,100)" />
                            <div className="armor-breakdown">
                              <strong>Maximum Armor</strong>:{" "}
                              {this.props.appGlobals.currentBattleMech.getMaxArmor()}
                              <br />
                              <strong>Total Armor</strong>:{" "}
                              {this.props.appGlobals.currentBattleMech.getTotalArmor()}
                              <br />
                              <strong>Unallocated Armor</strong>:{" "}
                              {this.props.appGlobals.currentBattleMech.getUnallocatedArmor()}
                              <br />
                            </div>
                          </div>
                        </>
                        ...
                        <>
                          <div className="armor-location-select quad">
                            <QuadArmorDiagramSVG strokeColor="rgb(100,100,100)" />
