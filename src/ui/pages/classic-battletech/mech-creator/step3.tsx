...
export default class MechCreatorStep3 extends React.Component<
  IHomeProps,
  IHomeState
> {
  ...
  render = (): JSX.Element => {
    ...
    let weightDropDownMax =
      this.props.appGlobals.currentBattleMech.getRemainingTonnage() +
      this.props.appGlobals.currentBattleMech.getAdditionalHeatSinks();
    if (
      weightDropDownMax <
      this.props.appGlobals.currentBattleMech.getAdditionalHeatSinks()
    ) {
            ...
            <div className="col-md-9 col-lg-10">
              <div className="row">
                <div className="col-md-12 col-lg-8">
                  <TextSection label="Step 3: Add additional heat sinks">
                    <p className="text-center">
                      Your BattleMech includes 10 heat sinks.
                    </p>
                    ...
                    <br />
                    {this.props.appGlobals.currentBattleMech.getHeatSinkCriticalRequirements()
                      .number > 0 ? (
                      <>
                        {this.props.appGlobals.currentBattleMech.getHeatSinkCriticalRequirements()
                          .number === 1 ? (
                          <p className="text-center">
                            One critical slot is required for your engine class
                            and selected heat sinks
                          </p>
                        ) : (
                          <p className="text-center">
                            {
                            ...
                            critical slots are required for your engine class
                            and selected heat sinks
                          </p>
                        )}
                      </>
                      ...
                      <p className="text-center">
                        No additional critical slots are required for your
                        engine class and selected heat sinks
                      </p>
                    )}
