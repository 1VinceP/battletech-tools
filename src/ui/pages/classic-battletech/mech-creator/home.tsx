...
export default class MechCreatorHome extends React.Component<
  IHomeProps,
  IHomeState
> {
  ...
  saveAsNew = (e: React.FormEvent<HTMLButtonElement>): void => {
    ...
    if (this.props.appGlobals.currentBattleMech) {
      ...
      if (!battleMechSaves) battleMechSaves = [];
  ...
  deleteSave = (
    ...
    if (this.props.appGlobals.battleMechSaves.length > saveIndex) {
      this.props.appGlobals.openConfirmDialog(
        ...
        "Aer you sure you want to delete the 'mech \"" +
          this.props.appGlobals.battleMechSaves[saveIndex].name +
          '"?',
        "Yes",
        "No, thank you",
        () => {
  ...
  saveOver = (
    ...
    if (
      ...
      this.props.appGlobals.battleMechSaves.length > saveIndex
    ) {
      this.props.appGlobals.openConfirmDialog(
        "Deletion Confirmation",
        "Aer you sure you want to save the currently loaded 'mech over the saved 'mech \"" +
          this.props.appGlobals.battleMechSaves[saveIndex].name +
          '"?',
        "Yes",
        "No, thank you",
  ...
  loadSave = (
    ...
    if (this.props.appGlobals.battleMechSaves.length > saveIndex) {
      ...
      currentBattleMech.import(
        this.props.appGlobals.battleMechSaves[saveIndex],
      );
      this.props.appGlobals.saveCurrentBattleMech(currentBattleMech);
    }
  };
            ...
            <div className="col-md-9 col-lg-10">
              <div className="row">
                <div className="col-md-12 col-lg-8">
                  <TextSection label="Welcome">
                    <p>Welcome to the BattleTech 'mech builder.</p>

                    <p>
                      This tool attempts to <em>closely</em> follow the steps in
                      the BattleTech TechManual and the steps in that book
                      should be referenced during 'mech creation
                    </p>
                    ...
                    <table className="table">
                      <thead>
                        <tr>
                          ...
                          <th title="This is the technology the mech is based on">
                            Tech
                          </th>
                          <th title="This is the tonnage">Tons</th>
                          <th title="This is the current battle value for the 'mech">
                            BV
                          </th>
                          <th title="This is the Alpha Strike Value">ASV</th>
                          <th
                            className="no-wrap"
                            title="This is the C-Bill cost"
                          >
                            C-Bills
                          </th>
                          <th></th>
                      ...
                      this.props.appGlobals.battleMechSaves.length > 0 ? (
                        <>
                          {this.props.appGlobals.battleMechSaves.map(
                            (mech, mechIndex) => {
                              let mechObj = new BattleMech(
                                JSON.stringify(mech),
                              );
                              return (
                                <tbody key={mechIndex}>
                                  <tr>
                                    <td title={"UUD: " + mech.uuid}>
                                      {mechObj.getName()}
                                    </td>
                                    <td>{mech.tech}</td>
                                    ...
                                    <td className="text-right">
                                      ...
                                      <button
                                        ...
                                        type="button"
                                        title={
                                          "Click here to save the currently loadoed over " +
                                          mech.name +
                                          ". You'll be prompted for confirmation."
                                        }
                                        onClick={(e) =>
                                          this.saveOver(e, mechIndex)
                                        }
                                      >
                                        <FaSave />
                                      </button>
                                      <button
                                        ...
                                        title={
                                          ...
                                          mech.name +
                                          " from this list. You'll be prompted for a confirmation."
                                        }
                                        onClick={(e) =>
                                          this.deleteSave(e, mechIndex)
                                        }
                                      >
                                        <FaTrash />
                                      </button>
