...
export default class MechCreatorStep2 extends React.Component<
  IHomeProps,
  IHomeState
> {
                ...
                <div className="col-md-12 col-lg-8">
                  <TextSection label="Step 2: Install engine and control systems">
                    ...
                    <label>
                      ...
                      <select
                        value={
                          this.props.appGlobals.currentBattleMech.getEngineType()
                            .tag
                        }
                    ...
                    <label>
                      ...
                      <select
                        value={
                          this.props.appGlobals.currentBattleMech.getGyro().tag
                        }
                        ...
                        {this.props.appGlobals.currentBattleMech
                          ...
                          .map((gyroData, gyroIndex) => {
                            if (gyroData.available) {
                              return (
                                <option key={gyroIndex} value={gyroData.tag}>
                                  {gyroData.name}
                                </option>
                              );
                            } else {
