...
export default class AlphaStrikeToggleRulerHexes extends React.Component<
  IAlphaStrikeToggleRulerHexesViewProps,
  IAlphaStrikeToggleRulerHexesViewState
> {
  toggleAlphaStrikeMeasurementsInHexes = (
    ...
    appSettings.alphaStrikeMeasurementsInHexes =
      !appSettings.alphaStrikeMeasurementsInHexes;
