...
export default class AlphaStrikeRosterPrint extends React.Component<
  IPrintProps,
  IPrintState
> {
  ...
  toggleBigVersion = (e: React.FormEvent<HTMLSpanElement>) => {
    ...
    localStorage.setItem("big_version", this.bigVersion ? "1" : "0");
        ...
        <header className="topmenu">
          <ul className="main-menu">
            ...
            {this.bigVersion ? (
              <li>
                <span
                  title="Click here to use the regular print version"
                  onClick={this.toggleBigVersion}
                  className="current"
                >
                  <FaMicroscope />
                </span>
              ...
              <li>
                <span
                  title="Click here to use the larger cards print version"
                  onClick={this.toggleBigVersion}
                  className="current"
                >
                  <FaGlasses />
          ...
          {this.bigVersion ? (
            <div className="header-message">
              Note: In my experience it's best to print these in Landscape.
              Don't forget to uncheck "headers and footers" to save space and
              unnecessary spacing.
            </div>
          ) : (
            <div className="header-message">
              Note: Don't forget to uncheck "headers and footers" to save space
                  ...
                  <div className={printSectionClass}>
                    <h2>
                      <div className="units-summary">
                        {group.getTotalPoints()} points -{" "}
                        {group.getTotalUnits()} units
                      </div>
