...
export default class AlphaStrikeUnitCreatorHome extends React.Component<
  IHomeProps,
  IHomeState
> {
  ...
  saveUnit = (doNotCalculate: boolean = false) => {
    if (!doNotCalculate) this.state.editingASUnit.calc();
    console.log("saveUnit", JSON.stringify(this.state.editingASUnit.export()));
    localStorage.setItem(
      "editing_as_unit",
      JSON.stringify(this.state.editingASUnit.export()),
    );
  };

  updateShortRange = (e: React.FormEvent<HTMLInputElement>): void => {
    let unit = this.state.editingASUnit;
  ...
  updateMediumRange = (e: React.FormEvent<HTMLInputElement>): void => {
    let unit = this.state.editingASUnit;
  ...
  updateLongRange = (e: React.FormEvent<HTMLInputElement>): void => {
    let unit = this.state.editingASUnit;
  ...
  updateExtremeRange = (e: React.FormEvent<HTMLInputElement>): void => {
    let unit = this.state.editingASUnit;
  ...
  setRole = (e: React.FormEvent<HTMLInputElement>): void => {
    let unit = this.state.editingASUnit;
  ...
  setType = (e: React.FormEvent<HTMLSelectElement>): void => {
    let unit = this.state.editingASUnit;
  ...
  updateArmor = (e: React.FormEvent<HTMLInputElement>): void => {
    let unit = this.state.editingASUnit;
  ...
  updateSize = (e: React.FormEvent<HTMLInputElement>): void => {
    let unit = this.state.editingASUnit;
  ...
  updateTMM = (e: React.FormEvent<HTMLInputElement>): void => {
    let unit = this.state.editingASUnit;
  ...
  updateStructure = (e: React.FormEvent<HTMLInputElement>): void => {
    let unit = this.state.editingASUnit;
  ...
  render = (): JSX.Element => {
    return (
      <>
        <UIPage
          current="alpha-strike-unit-creator"
        ...
        >
          ...
          <div className="row">
                ...
                <div className="row">
                  <div className="col-md-3">
                    ...
                    <InputCheckbox
                      label="Minimal"
                      checked={
                        this.state.editingASUnit.damage.shortMinimal
                          ? true
                          : false
                      }
                  ...
                  <div className="col-md-3">
                    ...
                    <InputCheckbox
                      label="Minimal"
                      checked={
                        this.state.editingASUnit.damage.mediumMinimal
                          ? true
                          : false
                      }
                  ...
                  <div className="col-md-3">
                    ...
                    <InputCheckbox
                      label="Minimal"
                      checked={
                        this.state.editingASUnit.damage.longMinimal
                          ? true
                          : false
                      }
                  ...
                  <div className="col-md-3">
                    ...
                    <InputCheckbox
                      label="Minimal"
                      checked={
                        this.state.editingASUnit.damage.extremeMinimal
                          ? true
                          : false
                      }
            ...
            <div className="col-md-6">
              ...
              <SanitizedHTML raw={true} html={this.state.calcLog} />
            </div>
          </div>
        </UIPage>
      </>
